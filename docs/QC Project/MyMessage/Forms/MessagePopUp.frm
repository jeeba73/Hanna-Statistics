...
If PopDown.Value = True Then    'MESSAGE POPDOWN
    
    popupdown = Me.top + 10 'GRADUALLY START THE MESSAGE DOWN (WARNING: CHANGING THIS VALUE MAY NOT WORK)
    Me.top = popupdown
    
    'Debug.Print Me.Top
            
        If Me.top = Screen.Height Then   'THIS IS VALUE OF MESSAGE TOP WHEN IT FULLY DISAPPEARES
        
            MessageUpDown.Enabled = False  'DISABLE MESSAGE POPDOWN
                
                If MessageUpDown.Enabled = False And PopDelay.Enabled = False Then
                On Error Resume Next
                Me.Hide   'WHEN DONE CLOSE MESSAGE
                End If
