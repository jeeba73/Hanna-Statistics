...
Begin VB.Form F_GRAPH 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Image DefaultMenu 
         ...
         Index           =   5
         Left            =   9360
         MouseIcon       =   "F_GRAPH.frx":6E66
         MousePointer    =   99  'Custom
         Picture         =   "F_GRAPH.frx":7170
         Top             =   6240
         Width           =   480
      End
   ...
   Begin VB.PictureBox PicMainMenu 
      ...
      Begin VB.PictureBox PicMenu 
         ...
         Begin VB.Image Image3 
            ...
            Index           =   0
            Left            =   735
            MouseIcon       =   "F_GRAPH.frx":A918
            MousePointer    =   99  'Custom
            Picture         =   "F_GRAPH.frx":AC22
            Top             =   180
            Width           =   480
         End
      ...
      Begin VB.PictureBox PicMenu 
         ...
         Begin VB.Image Image3 
            ...
            Index           =   1
            Left            =   735
            MouseIcon       =   "F_GRAPH.frx":E922
            MousePointer    =   99  'Custom
            Picture         =   "F_GRAPH.frx":EC2C
            Top             =   180
            Width           =   480
         End
      End
   ...
   Begin VB.Image PicZOOM 
      ...
      Index           =   0
      Left            =   3840
      MouseIcon       =   "F_GRAPH.frx":13554
      MousePointer    =   99  'Custom
      Picture         =   "F_GRAPH.frx":1385E
      Top             =   11040
      Width           =   480
   End
   Begin VB.Image PicZOOM 
      ...
      Index           =   1
      Left            =   5160
      MouseIcon       =   "F_GRAPH.frx":16C40
      MousePointer    =   99  'Custom
      Picture         =   "F_GRAPH.frx":16F4A
      Top             =   11040
      Width           =   480
   End
   Begin VB.Label L 
   ...
   End
   Begin VB.Image DefaultMenu 
      DragIcon        =   "F_GRAPH.frx":1AF54
      Height          =   480
      Index           =   0
      Left            =   18240
      MouseIcon       =   "F_GRAPH.frx":1E336
      MousePointer    =   99  'Custom
      Picture         =   "F_GRAPH.frx":1E640
      Top             =   11040
      Width           =   480
   End
   Begin VB.Image DefaultMenu 
      ...
      Index           =   3
      Left            =   480
      MouseIcon       =   "F_GRAPH.frx":21A22
      MousePointer    =   99  'Custom
      Picture         =   "F_GRAPH.frx":21D2C
      Top             =   11040
      Width           =   480
   End
   Begin VB.Image DefaultMenu 
      DragIcon        =   "F_GRAPH.frx":2510E
      Height          =   480
      Index           =   1
      Left            =   9360
      MouseIcon       =   "F_GRAPH.frx":284F0
      MousePointer    =   99  'Custom
      Picture         =   "F_GRAPH.frx":287FA
      Top             =   11040
      Width           =   480
   End
   Begin VB.Image DefaultMenu 
      ...
      Index           =   2
      Left            =   15960
      MouseIcon       =   "F_GRAPH.frx":2BBDC
      MousePointer    =   99  'Custom
      Picture         =   "F_GRAPH.frx":2BEE6
      Top             =   11040
      Width           =   480
   End
   Begin VB.Image DefaultMenu 
      ...
      Index           =   4
      Left            =   5880
      MouseIcon       =   "F_GRAPH.frx":2F2C8
      MousePointer    =   99  'Custom
      Picture         =   "F_GRAPH.frx":2F5D2
      Top             =   11040
      Visible         =   0   'False
      Width           =   480
   End
...
Select Case Index
    ...
    Case 1
        'If bFormSaved Then
             MyGraphicCheck = MyChemicalQCClean
            Unload Me
       ' Else
