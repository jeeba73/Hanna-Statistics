...
Begin VB.Form F_INFORMATION 
   ...
   Begin VB.PictureBox PicMain 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   4200
            Picture         =   "F_INFORMATION.frx":33E2
            Top             =   600
            Width           =   480
         End
      ...
      Begin VB.Label Label7 
         AutoSize        =   -1  'True
         BackStyle       =   0  'Transparent
         Caption         =   "Click on Label Code A to select Hanna Code"
         ForeColor       =   &H00404040&
         Height          =   285
         Left            =   2520
         TabIndex        =   190
      ...
      Begin VB.Label lbReagent 
         ...
         Index           =   51
         Left            =   5280
         MouseIcon       =   "F_INFORMATION.frx":67C4
      ...
      Begin VB.Label lbReagent 
         ...
         Index           =   50
         Left            =   1680
         MouseIcon       =   "F_INFORMATION.frx":6ACE
         MousePointer    =   99  'Custom
         TabIndex        =   114
         Top             =   2040
         Visible         =   0   'False
      ...
      Begin VB.Image DisableImage 
         Height          =   480
         Left            =   9360
         Picture         =   "F_INFORMATION.frx":6DD8
         Top             =   8880
         Visible         =   0   'False
         Width           =   480
      End
   ...
   Begin VB.PictureBox PicMain 
      ...
      Begin VB.Image ReloadMeter 
         Height          =   480
         Left            =   9360
         MouseIcon       =   "F_INFORMATION.frx":A1BA
         MousePointer    =   99  'Custom
         Picture         =   "F_INFORMATION.frx":A4C4
         Top             =   2520
         Visible         =   0   'False
         Width           =   480
      End
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.Image ImageTAV 
         ...
         Index           =   5
         Left            =   1720
         MouseIcon       =   "F_INFORMATION.frx":D8A6
         MousePointer    =   99  'Custom
         Picture         =   "F_INFORMATION.frx":DBB0
         Top             =   160
         Width           =   480
      End
   End
   Begin VB.PictureBox Picture4 
      ...
      Index           =   0
      Left            =   0
      MouseIcon       =   "F_INFORMATION.frx":10F92
      MousePointer    =   99  'Custom
      ScaleHeight     =   1815
      ScaleWidth      =   2775
      TabIndex        =   18
      ...
      Begin VB.Label Label2 
         ...
         Index           =   4
         Left            =   525
         MouseIcon       =   "F_INFORMATION.frx":1129C
         MousePointer    =   99  'Custom
         TabIndex        =   19
         Top             =   1080
         Width           =   1755
      ...
      Begin VB.Image Image4 
         ...
         Index           =   0
         Left            =   1200
         Picture         =   "F_INFORMATION.frx":115A6
         Top             =   480
         Width           =   480
      End
   End
   ...
   Begin VB.PictureBox PicMenuBar 
      ...
      Begin VB.PictureBox PicMenu 
         ...
         Index           =   3
         Left            =   8640
         MouseIcon       =   "F_INFORMATION.frx":14988
         MousePointer    =   99  'Custom
         ScaleHeight     =   1095
         ScaleWidth      =   1935
         TabIndex        =   65
         ...
         Begin VB.Label Label2 
            ...
            Index           =   3
            Left            =   0
            MouseIcon       =   "F_INFORMATION.frx":14C92
            MousePointer    =   99  'Custom
            TabIndex        =   66
            Top             =   720
            Width           =   1890
         ...
         Begin VB.Image Image3 
            ...
            Index           =   3
            Left            =   735
            MouseIcon       =   "F_INFORMATION.frx":14F9C
            MousePointer    =   99  'Custom
            Picture         =   "F_INFORMATION.frx":152A6
            Top             =   180
            Width           =   480
         End
      End
      Begin VB.PictureBox PicMenu 
         ...
         Index           =   0
         Left            =   0
         MouseIcon       =   "F_INFORMATION.frx":18688
         MousePointer    =   99  'Custom
         ScaleHeight     =   1095
         ScaleWidth      =   1935
         TabIndex        =   13
         ...
         Begin VB.Image Image3 
            ...
            Index           =   0
            Left            =   720
            MouseIcon       =   "F_INFORMATION.frx":18992
            MousePointer    =   99  'Custom
            Picture         =   "F_INFORMATION.frx":18C9C
            Top             =   180
            Width           =   480
         End
         Begin VB.Label Label2 
            ...
            Index           =   0
            Left            =   60
            MouseIcon       =   "F_INFORMATION.frx":1C07E
            MousePointer    =   99  'Custom
            TabIndex        =   14
            Top             =   720
            Width           =   1875
      ...
      Begin VB.PictureBox PicMenu 
         ...
         Index           =   1
         Left            =   1920
         MouseIcon       =   "F_INFORMATION.frx":1C388
         MousePointer    =   99  'Custom
         ScaleHeight     =   1095
         ScaleWidth      =   1935
         TabIndex        =   11
         ...
         Begin VB.Label Label2 
            ...
            Index           =   1
            Left            =   60
            MouseIcon       =   "F_INFORMATION.frx":1C692
            MousePointer    =   99  'Custom
            TabIndex        =   12
            Top             =   720
            Width           =   1875
         ...
         Begin VB.Image Image3 
            ...
            Left            =   735
            MousePointer    =   99  'Custom
            Picture         =   "F_INFORMATION.frx":1C99C
            Top             =   180
            Width           =   480
         End
      End
      Begin VB.PictureBox PicMenu 
         ...
         Index           =   2
         Left            =   3840
         MouseIcon       =   "F_INFORMATION.frx":1FD7E
         MousePointer    =   99  'Custom
         ScaleHeight     =   1095
         ScaleWidth      =   1935
         TabIndex        =   9
         ...
         Begin VB.Label Label2 
            ...
            Index           =   2
            Left            =   0
            MouseIcon       =   "F_INFORMATION.frx":20088
            MousePointer    =   99  'Custom
            TabIndex        =   10
            Top             =   720
            Width           =   1890
         ...
         Begin VB.Image Image3 
            ...
            Index           =   2
            Left            =   735
            MouseIcon       =   "F_INFORMATION.frx":20392
            MousePointer    =   99  'Custom
            Picture         =   "F_INFORMATION.frx":2069C
            Top             =   180
            Width           =   480
         End
      End
      Begin VB.Label LaInfo 
         ...
         Height          =   225
         Left            =   13200
         MouseIcon       =   "F_INFORMATION.frx":23A7E
         MousePointer    =   99  'Custom
         TabIndex        =   162
         Top             =   795
         Visible         =   0   'False
   ...
   Begin VB.Label DefaultMenuLabel 
      ...
      Index           =   3
      Left            =   0
      MouseIcon       =   "F_INFORMATION.frx":23D88
      MousePointer    =   99  'Custom
      TabIndex        =   5
      Top             =   10680
      Width           =   1815
   ...
   Begin VB.Label DefaultMenuLabel 
      ...
      Index           =   0
      Left            =   17640
      MouseIcon       =   "F_INFORMATION.frx":24092
      MousePointer    =   99  'Custom
      TabIndex        =   4
      Top             =   10800
      Width           =   1575
   ...
   Begin VB.Label DefaultMenuLabel 
      ...
      Index           =   2
      Left            =   15240
      MouseIcon       =   "F_INFORMATION.frx":2439C
      MousePointer    =   99  'Custom
      TabIndex        =   2
      Top             =   10680
      Width           =   2175
   ...
   Begin VB.Label DefaultMenuLabel 
      ...
      Index           =   1
      Left            =   8280
      MouseIcon       =   "F_INFORMATION.frx":246A6
      MousePointer    =   99  'Custom
      TabIndex        =   3
      Top             =   10560
      Width           =   2655
   ...
   Begin VB.Label La 
      ...
      Index           =   2
      Left            =   17655
      MouseIcon       =   "F_INFORMATION.frx":249B0
      MousePointer    =   99  'Custom
      TabIndex        =   165
      Top             =   11600
      Width           =   1200
   ...
   Begin VB.Label La 
      ...
      Index           =   1
      Left            =   15630
      MouseIcon       =   "F_INFORMATION.frx":24CBA
      MousePointer    =   99  'Custom
      TabIndex        =   164
      Top             =   11600
      Width           =   1230
   ...
   Begin VB.Label La 
      ...
      Index           =   0
      Left            =   9000
      MouseIcon       =   "F_INFORMATION.frx":24FC4
      MousePointer    =   99  'Custom
      TabIndex        =   163
      Top             =   11600
      Width           =   1200
   ...
   Begin VB.Image DefaultMenu 
      ...
      Index           =   4
      Left            =   2040
      MouseIcon       =   "F_INFORMATION.frx":252CE
      MousePointer    =   99  'Custom
      Picture         =   "F_INFORMATION.frx":255D8
      Top             =   11040
      Visible         =   0   'False
      Width           =   480
   End
   Begin VB.Image DefaultMenu 
      ...
      Index           =   2
      Left            =   15960
      MouseIcon       =   "F_INFORMATION.frx":289BA
      MousePointer    =   99  'Custom
      Picture         =   "F_INFORMATION.frx":28CC4
      Top             =   11040
      Width           =   480
   End
   Begin VB.Image DefaultMenu 
      DragIcon        =   "F_INFORMATION.frx":2C0A6
      Height          =   480
      Index           =   1
      Left            =   9360
      MouseIcon       =   "F_INFORMATION.frx":2F488
      MousePointer    =   99  'Custom
      Picture         =   "F_INFORMATION.frx":2F792
      Top             =   11040
      Width           =   480
   End
   Begin VB.Image DefaultMenu 
      ...
      Index           =   3
      Left            =   360
      MouseIcon       =   "F_INFORMATION.frx":32B74
      MousePointer    =   99  'Custom
      Picture         =   "F_INFORMATION.frx":32E7E
      Top             =   11040
      Width           =   480
   End
   Begin VB.Line Line1 
   ...
   End
   Begin VB.Image DefaultMenu 
      DragIcon        =   "F_INFORMATION.frx":36260
      Height          =   480
      Index           =   0
      Left            =   18240
      MouseIcon       =   "F_INFORMATION.frx":39642
      MousePointer    =   99  'Custom
      Picture         =   "F_INFORMATION.frx":3994C
      Top             =   11040
      Width           =   480
   End
End
...
Public Function DoShow(ByRef Index As Integer, Optional ByRef sLot As String, Optional ByRef sCode As String, Optional ByVal lngID As Long, Optional MyImage As Image, Optional FileName As String) As Boolean
    ...
    Call SetCmbCode(cmbCode)
    Call SetCmbCode(cmbCode2)
...
Private Sub chLot_Click(Index As Integer)
Dim rc As Boolean
rc = IIf(chLot(Index).Value = 1, True, False)
chLot(Index).ForeColor = IIf(rc, vbColorOrange, vbWhite)
chLot(Index).FontBold = rc
End Sub

Private Sub cmbCode_Click()
    cmbCode.Visible = False
    If IndexCode > 0 Then
    Label1(IndexCode).Caption = cmbCode
    End If
    
    
End Sub

Private Sub cmbCode2_Click()
    cmbCode2.Visible = False
    If IndexCode > 0 Then
    Label1(IndexCode).Caption = cmbCode2
    End If
...
Select Case IndexTextSelected
  Case 3, 16 To 20, 27, 29, 50 To 54, 59, 61
...
Private Sub Label1_Change(Index As Integer)
      ...
      Select Case Index
        Case 11 To 15
            ...
            Label1(Index).BackColor = IIf(Len(Label1(Index)) > 0, vbColorTextBlue, vbColorLabelUnabled)
         Case 45 To 49
...
cmbCode2.Visible = False
    Select Case Index
        Case 11 To 15
            ...
            ' visualizza cmbCode e seleziona un hannacode
            cmbCode.Move Label1(Index).Left, Label1(Index).Top + Label1(Index).Height
        ...
        Case 45 To 49
            ...
            ' visualizza cmbCode e seleziona un hannacode
            cmbCode2.Move Label1(Index).Left, Label1(Index).Top + Label1(Index).Height
...
cmbCode2.Visible = False
    ...
    If (Index < 11 And Index > 15) Or (Index < 45 And Index > 49) Then
    ...
    Select Case t
        Case 11 To 15
            mrc = IIf(Len(Text1(t)) > 0, True, False)
            chLot(t - 11).Visible = mrc
            
         Case 45 To 49
            mrc = IIf(Len(Text1(t)) > 0, True, False)
            chLot(t - 40).Visible = mrc
        Case 33
            mrc = IIf(Len(Text1(t)) > 0, True, False)
            Text1(t + 1).Enabled = mrc
            Text1(t + 2).Enabled = mrc
...
Private Sub FrameIntroVisible(ByVal rc As Boolean)
        ...
        frCommandInside(2).Visible = Not (rc)
End Sub
...
Dim rc As Boolean
Dim strReagentLot As String
Dim strReagentCode As String
Dim strReagentLot2 As String
Dim strReagentCode2 As String
On Error GoTo ERR_SAVE:
rc = True

Call SetReagentSring(strReagentLot, strReagentCode, strReagentLot2, strReagentCode2)
...
With dbTabReport
    ...
    End If
        ...
        !ReagentLot = strReagentLot
        !ReagentCode = strReagentCode
        !ReagentLot2 = strReagentLot2
        !ReagentCode2 = strReagentCode2
...
Dim MeasurementUnit As String
    ...
    With dbTabCode
        ...
        Else
            ...
            Text1(0) = sLot
            Text1(1) = sCode
            Text1(2) = IIf(IsNull(Trim(!ProductName)), "", Trim(!ProductName))
...
Dim i As Integer
    ...
    For i = 11 To 15
        ...
        SaveSettingData SettingName, "Information QC", "Reagent Code" & i, Label1(i)
    Next
    ...
    For i = chLot.LBound To chLot.UBound
    
        SaveSettingData SettingName, "Information QC", "chLot" & i, chLot(i).Value
...
Dim i As Integer
  ...
  '  End If
    ...
    For i = 11 To 15
        Label1(i).Caption = GetSettingData(SettingName, "Information QC", "Reagent Code" & i, "Code " & Chr$(54 + i))
    Next
    ...
    For i = chLot.LBound To chLot.UBound
         ...
         chLot(i).Value = GetSettingData(SettingName, "Information QC", "chLot" & i, chLot(i).Value)
...
Private Function SetReagentSring(ByRef strReagentLot As String, ByRef strReagentCode As String, ByRef strReagentLot2 As String, ByRef strReagentCode2 As String) As Boolean
Dim i As Integer
Dim rc As Boolean
Dim subString As String
Dim MyNewString As String
Dim ResultLotString As String
Dim ResultCodeString As String
...
On Error GoTo ERR_SET:
    ...
    subString = IIf(InStr(MyCode, "A-"), "A-", IIf(InStr(MyCode, "B-"), "B-", IIf(InStr(MyCode, "C-"), "C-", IIf(InStr(MyCode, "D-"), "D-", ""))))


   For i = 11 To 15
        If Text1(i) <> "" Then
            MyNewString = Label1(i) ' Replace(MyCode, subString, UCase(Chr(54 + i) & "-"))
            If Len(ResultCodeString) > 0 Then
                ResultCodeString = IIf(InStr(ResultCodeString, MyNewString), ResultCodeString, ResultCodeString & ";" & MyNewString)
                ResultLotString = IIf(InStr(ResultLotString, Text1(i)), ResultLotString, ResultLotString & ";" & Text1(i))
            Else
                ResultCodeString = MyNewString
                ResultLotString = Text1(i)
            End If
   ...
   Next
    ...
    If ResultLotString <> "" Then
        strReagentLot = ResultLotString
        strReagentCode = ResultCodeString
    End If
    
    SaveSettingData SettingName, "Information QC", "strReagentLot", strReagentLot
    SaveSettingData SettingName, "Information QC", "strReagentCode", strReagentCode
    ...
    For i = 45 To 49
         If Text1(i) <> "" Then
            ' MyNewString = Replace(MyCode, subString, UCase(Chr(20 + i) & "-"))
              MyNewString = Label1(i)
             ResultCodeString = IIf(InStr(ResultCodeString, MyNewString), ResultCodeString, ResultCodeString & ";" & MyNewString)
             ResultLotString = IIf(InStr(ResultLotString, Text1(i)), ResultLotString, ResultLotString & ";" & Text1(i))
         End If
    ...
    Next
    If ResultLotString <> "" Then
        strReagentLot2 = Right(ResultLotString, Len(ResultLotString) - 1)
        strReagentCode2 = Right(ResultCodeString, Len(ResultCodeString) - 1)
    End If
    
      
    SaveSettingData SettingName, "Information QC", "strReagentLot2", strReagentLot2
    SaveSettingData SettingName, "Information QC", "strReagentCode2", strReagentCode2
...
Private Function ExportFile()
    ...
    szFilename = GetFolder(Me.hWnd, USER_PATH)
    If szFilename = "" Then Exit Function
    
     FileCopy USER_PATH & SettingName, szFilename & "\" & SettingName
     
     PopupMessage 2, "Export copleted...", , , SettingName
