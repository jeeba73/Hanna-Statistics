...
picDraw.DrawStyle = 0
            ...
            If MySTDMin <> lngHeight / 2 Then
                ...
                picDraw.Print "Min"
                 picDraw.Line (OffLeft, MySTDMin)-(lngWidth + OffLeft / 2, MySTDMin), vbRed ' mudtGraphProps.MeanColor     ' vbGreen ' mudtGraphProps.AxisColor
            End If
            If MySTDMax <> lngHeight / 2 And MySTDMax > 0 Then
                ...
                picDraw.Print "Max"
                picDraw.Line (OffLeft, MySTDMax)-(lngWidth + OffLeft / 2, MySTDMax), vbRed ' vbRed ' mudtGraphProps.AxisColor
            End If
...
'picDraw.DrawWidth = 1
             ...
             ' picDraw.Line (OffLeft, S2Più)-( lngWidth, S2Più), &H4080&   ' vbRed ' mudtGraphProps.AxisColor
            ...
            If mudtGraphProps.ShowAxis Then
                ...
                picDraw.Line (OffLeft, lngHeight / 2)-(lngWidth + OffLeft / 2, lngHeight / 2), vbColorTextDarkBlue  ' mudtGraphProps.AxisColor
                picDraw.DrawWidth = 1
                    ...
                    If mudtGraphProps.ShowBars Then
                        ...
                        If mudtGraphProps.ShowBarsColor Then
                            Select Case PointIndex(lngIndex)
                                Case 0
                                     mudtGraphProps.BarColor = &H964901
                    ...
                    If lngIndex Mod mudtGraphProps.XGridInc = 0 Or lngIndex = 1 Then
                        ...
                        If udtPoints(lngIndex).Y < lngHeight / 2 Then
                            If udtPoints(lngIndex).Y < MySTDMax Then
                                 mudtGraphProps.PointColor = vbRed
                            Else
...
Dim Virgola As Integer
 ...
 picDraw.DrawStyle = 2
            ...
            picDraw.Line (MySTDMin, 700)-(MySTDMin, lngHeight - 300), vbRed ' &H4080& ' mudtGraphProps.MeanColor     ' vbGreen ' mudtGraphProps.AxisColor
            ...
            If mudtGraphProps.s2 > 0 Then
                ...
                picDraw.Line (MySTDMax, 700)-(MySTDMax, lngHeight - 300), vbRed ' &H4080&  ' vbRed ' mudtGraphProps.AxisColor
...
picDraw.DrawStyle = 0
            ...
            If lngCount > 0 And (mudtGraphProps.ShowLines Or mudtGraphProps.ShowBars) Then
                For lngIndex = 1 To UBound(udtPoints)
                    ...
                    If mudtGraphProps.ShowLines And lngIndex > 1 Then
                        picDraw.DrawWidth = 2
                        DrawLine udtPoints(lngIndex - 1), udtPoints(lngIndex), &H964901 'mudtGraphProps.LineColor
                        picDraw.DrawWidth = 1
                  End If
                Next lngIndex
            End If
...
Public Sub PrintChart()
    ...
    'uPrinterFit = prtFitStretched
    uPrinterOrientation = 0 ' vbPRORPortrait ' vbPRDPVertical  ' vbPRORLandscape
    uLegendPrintMode = legPrintGraph
    Printer.ScaleWidth = 11899
    Printer.ScaleHeight = 16838
    Printer.ScaleMode = 1
   ...
   ' Printer.Orientation = uPrinterOrientation
    ...
    With picToPrinter
        .Cls
        sngW = UserControl.ScaleWidth 'IIf(bDisplayLegend = True, picSplitter.Left, UserControl.ScaleWidth)
        ...
        Select Case uPrinterFit
            Case prtFitStretched
                If (uLegendPrintMode = legPrintGraph) Then
                   ...
                   .Width = Printer.ScaleWidth * Printer.ScaleX(picDraw.Width, UserControl.ScaleMode, Printer.ScaleMode) / UserControl.ScaleWidth
                ...
                .PaintPicture picDraw.Image, 0, 0, .Width, .Height, 0, 0, sngW, sngH
            ...
            Case Else
                ...
                .PaintPicture picDraw.Image, 0, 0, sngW, sngH, 0, 0, sngW, sngH
    ...
    With picToPrinter
        ...
        str_grafico = IIf(mudtGraphProps.ShowGaussian, "Gaussian Chart", "Average Chart")
        Call DefaultValue(str_grafico, INDEX_STD)
        Call PrintGrafico(picDraw, str_grafico, INDEX_STD)
...
Private Function GetPointsOLD(ByVal plngLeft As Long, ByVal plngRight As Long, ByVal plngTop As Long, ByVal plngBottom As Long, ByVal plngBarWidth As Long) As mtypPOINT()
Dim udtPoints() As mtypPOINT
Dim lngCount    As Long
Dim lngIndex    As Long
Dim objPoint    As Point
    ...
    If lngCount > 0 Then
        ...
        For Each objPoint In mobjPoints
            ...
            If (mudtGraphProps.MaxValue - mudtGraphProps.MinValue) <> 0 Then
                lngYAxis = ((picDraw.ScaleHeight - 15) / (mudtGraphProps.MaxValue - mudtGraphProps.MinValue)) * mudtGraphProps.MaxValue
                udtPoints(lngIndex).Y = lngYAxis - objPoint.Value * ((plngBottom - plngTop) / (mudtGraphProps.MaxValue - mudtGraphProps.MinValue))
                If FormatNumber(objPoint.RealValue, 7) = FormatNumber(mudtGraphProps.YMaxDevST, 7) Then
                    XMaxDevST = udtPoints(lngIndex).X
                End If
            End If
