...
Begin VB.Form F_SEARCHARCH 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.Label Label1 
         ...
         Caption         =   "Import Database file. Click on ... and open browser folder. please select : dbCode.mdb"
         BeginProperty Font 
            Name            =   "Calibri"
            Size            =   12
            Charset         =   0
      ...
      Begin VB.Label Label2 
         AutoSize        =   -1  'True
         BackStyle       =   0  'Transparent
         Caption         =   "Import Common Database file"
         BeginProperty Font 
            Name            =   "Calibri"
            Size            =   21.75
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "F_SEARCHARCH"
...
Private Sub Command1_Click()
    ...
    If CheckFilePath(szFilename, m_path, dbCodeName, m_old_name) Then
    ...
    m_path = m_path & "\"
    txt_ARCHIVIO = m_path & dbCodeName
