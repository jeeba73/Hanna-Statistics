...
Public Function FormatNomeFile_ATP(ByVal MyName As String) As String
    Dim rc As Boolean
    Dim i As Integer
    Dim sString As String
    Dim LeftString As String
    Dim RightString As String
    Dim AccPosition As Integer
    Dim sTrDaModificare(10) As Variant
    ...
    FormatNomeFile_ATP = MyName
    'MsgBox FormatNomeFile
End Function

Public Function CopyDatabase(ByVal Destinationpath As String, ByVal Filepath As String)
    dbChemicalQC.Close
