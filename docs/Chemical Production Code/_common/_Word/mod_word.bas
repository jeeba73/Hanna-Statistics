...
Public Function LetPrint(ByVal NumReport As String, Optional ByVal bPrint As Boolean = True, Optional ByVal bPreparation As Boolean) As Boolean
    If LoadCertificato(bPreparation) Then
        LetPrint = F_PRINT.DoShow(NumReport, bPrint, bPreparation)
    End If
End Function
