...
Public Sub SetDatabaseProductionTable(ByVal Grd As Grid)
...
Public Sub SetDatabaseProductionHistory(ByVal Grd As Grid)
Dim i As Integer
        '------------------------------------------------
...
Dim i As Integer
    ...
    With Grd
        ...
        .Cell(0, 20).Text = "QC Status"
        .Cell(0, 21).Text = "QC Date"
        .Cell(0, 22).Text = "Qty To Produce"
        .Cell(0, 23).Text = "Qty Produced"
        .Cell(0, 24).Text = "SFGLot"
