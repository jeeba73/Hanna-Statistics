    ...
    With Pr
       ...
       'personalizzo le caratteristiche del font
            ...
            ' .PrintLeft 20, 10, Societa
             .FontBold = True
             .FontSize = 16
             .PrintLeft 20, 20, ("HANNA INSTRUMENTS srl - Chemical Production")
            ' .FontSize = 14
       ...
       .FontSize = 14
     '  .PrintCentre (dx + Sx) / 2, 69, Production.HannaCode.Code & " - " & sString
...
With Pr
   ...
   .FontBold = False
   .FontSize = 9
  ' .PrintLeft 15, 35 + passo, "Code : " & Production.HannaCode.Code, 1
   passo = passo + AltCar + 1
  ' .PrintLeft 15, 35 + passo, "Description : " & Production.HannaCode.Description, 1
   passo = passo + AltCar + 1
  ' .PrintLeft 15, 35 + passo, "Lot : " & Production.Lot, 1
   passo = passo + AltCar + 1
   .FontSize = 9
  ' .PrintLeft 15, 35 + passo, "Recipe : " & Production.HannaCode.Recipe, 1
   passo = passo + AltCar
  '  .PrintLeft 15, 35 + passo, ("Exp : ") & Production.Exp, 1
   passo = passo + AltCar
   ' .PrintLeft 15, 35 + passo, ("Prod - First Day : ") & Production.ProdFirst, 1
   ' .PrintLeft 60, 35 + passo, ("Prod - Last Day : ") & Production.ProdLast, 1
   passo = passo + AltCar
