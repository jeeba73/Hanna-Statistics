VERSION 5.00
Begin VB.Form MessageDownloadFade 
   Appearance      =   0  'Flat
   BackColor       =   &H80000005&
   BorderStyle     =   0  'None
   ClientHeight    =   1710
   ...
   Begin VB.Label lClose 
      ...
      Height          =   255
      Left            =   360
      MouseIcon       =   "MessageDownloadFade.frx":0000
   ...
   Begin VB.Label lDescription 
      BackStyle       =   0  'Transparent
      Caption         =   "Files scaricati dal Server..."
      BeginProperty Font 
         Name            =   "Calibri"
         Size            =   12
         Charset         =   0
   ...
   Begin VB.Image Image3 
      Height          =   1185
      Left            =   120
      Picture         =   "MessageDownloadFade.frx":030A
      Top             =   360
      Width           =   1275
   End
   ...
   End
End
Attribute VB_Name = "MessageDownloadFade"
...
If FadeDelay.Interval > 2999 Then
    ...
    MessageDownloadFade.Enabled = True
...
MessageDownloadFade.Enabled = True  'KEEP MESSAGE FADING
End Sub
...
If FadeIn.value = True Then
    ...
    Else
       ...
       ' MessageDownloadFade.Enabled = False     'STOP WHEN FULLY APPEARED
...
If FadeOut.value = True Then
    ...
    Else
        ...
        MessageDownloadFade.Enabled = False     'STOP WHEN FULLY DISAPPEARED
