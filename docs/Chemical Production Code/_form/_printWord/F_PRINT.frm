...
Private bPrepTemplate As Boolean
Public Function DoShow(ByVal mCodice As String, Optional ByVal bPrint As Boolean = True, Optional ByVal bPreparation As Boolean) As Boolean
...
Private Sub DoInitialize()
    ...
    sString = "Printing pdf file..."
        ...
        lbl_Form = "Printing Report NR" & sNumReport
...
Private Function SetPrinterMaterialRequisition(ByVal NumReport As String) As Boolean
    ...
    If CreateWord(WordApp) Then
            ...
            If bPrepTemplate Then
                sPath = mPath & PathPrepRequisition
            Else
