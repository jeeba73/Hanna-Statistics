...
Public Function DoShow(Optional ByRef Code As String, Optional FormTop As Double, Optional ByVal Index = 0) As Boolean
...
Select Case Index
    ...
    Case 1
        m_rc = False
    Case 2
        Call F_PICTOGRAM.DoShow(MyID, 2, RecipeCode)
        Exit Sub
End Select
...
If MyID > 0 Then
    frCommandInside_Click IIf(indexProcedure = 0, 0, 2)
End If
