...
Public Function DoShow(Optional ByRef UserHannaCode As String, Optional FormTop As Double, Optional ByRef ID As Long, Optional ByVal Index = 0, Optional ByRef strRecipe As String) As Boolean
...
Select Case Index
    ...
    Case 1
        m_rc = False
    Case 2
        Call F_PICTOGRAM.DoShow(MyID, 0, uHannaCode)
        Exit Sub
End Select
