...
Begin VB.Form FormPreparationDatabaseHistory 
   ...
   Begin ChemicalProduction.ctlCalendar ctlCalendar1 
      ...
      fontheader      =   "FormPreparationDatabaseHistory.frx":3724
      fontday         =   "FormPreparationDatabaseHistory.frx":3750
      fonttoday       =   "FormPreparationDatabaseHistory.frx":3776
      fontcolumn      =   "FormPreparationDatabaseHistory.frx":37A4
   End
   Begin VB.PictureBox Picture3 
      ...
      Begin VB.PictureBox Picture1 
         ...
         Height          =   855
         Left            =   10680
         MouseIcon       =   "FormPreparationDatabaseHistory.frx":37D0
         ScaleHeight     =   855
         ScaleWidth      =   4455
         TabIndex        =   35
         Top             =   160
         ...
         Begin VB.Image DefaultMenu 
            ...
            Index           =   8
            Left            =   2040
            MouseIcon       =   "FormPreparationDatabaseHistory.frx":3ADA
            MousePointer    =   99  'Custom
            Picture         =   "FormPreparationDatabaseHistory.frx":3DE4
            Top             =   200
            Visible         =   0   'False
            Width           =   480
         End
      ...
      Begin VB.Image DefaultMenu 
         ...
         Index           =   0
         Left            =   9360
         MouseIcon       =   "FormPreparationDatabaseHistory.frx":71C6
         MousePointer    =   99  'Custom
         Picture         =   "FormPreparationDatabaseHistory.frx":74D0
         Top             =   240
         Width           =   480
      End
      Begin VB.Image DefaultMenu 
         ...
         Index           =   1
         Left            =   4560
         MouseIcon       =   "FormPreparationDatabaseHistory.frx":A8B2
         MousePointer    =   99  'Custom
         Picture         =   "FormPreparationDatabaseHistory.frx":ABBC
         Top             =   240
         Width           =   480
      End
      Begin VB.Image DefaultMenu 
         ...
         Index           =   2
         Left            =   600
         MouseIcon       =   "FormPreparationDatabaseHistory.frx":DF9E
         MousePointer    =   99  'Custom
         Picture         =   "FormPreparationDatabaseHistory.frx":E2A8
         Top             =   240
         Width           =   480
      End
      Begin VB.Image DefaultMenu 
         ...
         Index           =   3
         Left            =   15600
         MouseIcon       =   "FormPreparationDatabaseHistory.frx":1168A
         MousePointer    =   99  'Custom
         Picture         =   "FormPreparationDatabaseHistory.frx":11994
         Top             =   240
         Width           =   480
      End
      Begin VB.Image DefaultMenu 
         ...
         Index           =   4
         Left            =   18240
         MouseIcon       =   "FormPreparationDatabaseHistory.frx":14D76
         MousePointer    =   99  'Custom
         Picture         =   "FormPreparationDatabaseHistory.frx":15080
         Top             =   240
         Width           =   480
      End
      Begin VB.Label Lab 
         ...
         Index           =   5
         Left            =   450
         MouseIcon       =   "FormPreparationDatabaseHistory.frx":18462
         MousePointer    =   99  'Custom
         TabIndex        =   45
         Top             =   795
         Width           =   960
      ...
      Begin VB.Label Lab 
         ...
         Index           =   6
         Left            =   4335
         MouseIcon       =   "FormPreparationDatabaseHistory.frx":1876C
         MousePointer    =   99  'Custom
         TabIndex        =   44
         Top             =   795
         Width           =   930
      ...
      Begin VB.Label Lab 
         ...
         Index           =   7
         Left            =   9015
         MouseIcon       =   "FormPreparationDatabaseHistory.frx":18A76
         MousePointer    =   99  'Custom
         TabIndex        =   43
         Top             =   795
         Width           =   1140
      ...
      Begin VB.Label Lab 
         ...
         Index           =   11
         Left            =   15360
         MouseIcon       =   "FormPreparationDatabaseHistory.frx":18D80
         MousePointer    =   99  'Custom
         TabIndex        =   42
         Top             =   795
         Width           =   1230
      ...
      Begin VB.Label Lab 
         ...
         Index           =   12
         Left            =   17760
         MouseIcon       =   "FormPreparationDatabaseHistory.frx":1908A
         MousePointer    =   99  'Custom
         TabIndex        =   41
         Top             =   795
         Width           =   1200
      ...
      Begin VB.Label DefaultMenuLabel 
         ...
         Index           =   4
         Left            =   17400
         MouseIcon       =   "FormPreparationDatabaseHistory.frx":19394
         MousePointer    =   99  'Custom
         TabIndex        =   40
         Top             =   -120
         Width           =   1815
      ...
      Begin VB.Label DefaultMenuLabel 
         ...
         Index           =   3
         Left            =   15000
         MouseIcon       =   "FormPreparationDatabaseHistory.frx":1969E
         MousePointer    =   99  'Custom
         TabIndex        =   39
         Top             =   -120
         Width           =   2055
      ...
      Begin VB.Label DefaultMenuLabel 
         ...
         Index           =   0
         Left            =   8640
         MouseIcon       =   "FormPreparationDatabaseHistory.frx":199A8
         MousePointer    =   99  'Custom
         TabIndex        =   38
         Top             =   -120
         Width           =   2055
      ...
      Begin VB.Label DefaultMenuLabel 
         ...
         Index           =   1
         Left            =   3720
         MouseIcon       =   "FormPreparationDatabaseHistory.frx":19CB2
         MousePointer    =   99  'Custom
         TabIndex        =   37
         Top             =   10680
         Width           =   2055
      ...
      Begin VB.Label DefaultMenuLabel 
         ...
         Index           =   2
         Left            =   0
         MouseIcon       =   "FormPreparationDatabaseHistory.frx":19FBC
         MousePointer    =   99  'Custom
         TabIndex        =   36
         Top             =   -120
         Width           =   2055
   ...
   Begin VB.PictureBox PicMainMenu 
      ...
      Begin VB.PictureBox PicMenu 
         ...
         Index           =   5
         Left            =   9600
         MouseIcon       =   "FormPreparationDatabaseHistory.frx":1A2C6
         MousePointer    =   99  'Custom
         ScaleHeight     =   1095
         ScaleWidth      =   1935
         TabIndex        =   48
         ...
         Begin VB.Image Image3 
            ...
            Index           =   5
            Left            =   720
            MouseIcon       =   "FormPreparationDatabaseHistory.frx":1A5D0
            MousePointer    =   99  'Custom
            Picture         =   "FormPreparationDatabaseHistory.frx":1A8DA
            Top             =   180
            Width           =   480
         End
         Begin VB.Label Label2 
            ...
            Index           =   5
            Left            =   0
            MouseIcon       =   "FormPreparationDatabaseHistory.frx":1D2CC
            MousePointer    =   99  'Custom
            TabIndex        =   49
            Top             =   720
            Width           =   1890
      ...
      Begin VB.PictureBox PicMenu 
         ...
         Index           =   4
         Left            =   5760
         MouseIcon       =   "FormPreparationDatabaseHistory.frx":1D5D6
         MousePointer    =   99  'Custom
         ScaleHeight     =   1095
         ScaleWidth      =   1935
         TabIndex        =   27
         ...
         Begin VB.Label Label2 
            ...
            Index           =   4
            Left            =   0
            MouseIcon       =   "FormPreparationDatabaseHistory.frx":1D8E0
            MousePointer    =   99  'Custom
            TabIndex        =   28
            Top             =   720
            Width           =   1890
         ...
         Begin VB.Image Image3 
            ...
            Index           =   4
            Left            =   720
            MouseIcon       =   "FormPreparationDatabaseHistory.frx":1DBEA
            MousePointer    =   99  'Custom
            Picture         =   "FormPreparationDatabaseHistory.frx":1DEF4
            Top             =   180
            Width           =   480
         End
      End
      Begin VB.PictureBox PicMenu 
         ...
         Index           =   0
         Left            =   0
         MouseIcon       =   "FormPreparationDatabaseHistory.frx":212D6
         MousePointer    =   99  'Custom
         ScaleHeight     =   1095
         ScaleWidth      =   1935
         TabIndex        =   23
         ...
         Begin VB.Image Image3 
            ...
            Index           =   0
            Left            =   720
            MouseIcon       =   "FormPreparationDatabaseHistory.frx":215E0
            MousePointer    =   99  'Custom
            Picture         =   "FormPreparationDatabaseHistory.frx":218EA
            Top             =   180
            Width           =   480
         End
         Begin VB.Label Label2 
            ...
            Index           =   0
            Left            =   525
            MouseIcon       =   "FormPreparationDatabaseHistory.frx":24CCC
            MousePointer    =   99  'Custom
            TabIndex        =   24
            Top             =   720
            Width           =   960
      ...
      Begin VB.PictureBox PicMenu 
         ...
         Index           =   1
         Left            =   1920
         MouseIcon       =   "FormPreparationDatabaseHistory.frx":24FD6
         MousePointer    =   99  'Custom
         ScaleHeight     =   1095
         ScaleWidth      =   1935
         TabIndex        =   21
         ...
         Begin VB.Image Image3 
            ...
            Index           =   1
            Left            =   720
            MouseIcon       =   "FormPreparationDatabaseHistory.frx":252E0
            MousePointer    =   99  'Custom
            Picture         =   "FormPreparationDatabaseHistory.frx":255EA
            Top             =   180
            Width           =   480
         End
         Begin VB.Label Label2 
            ...
            Index           =   1
            Left            =   195
            MouseIcon       =   "FormPreparationDatabaseHistory.frx":289CC
            MousePointer    =   99  'Custom
            TabIndex        =   22
            Top             =   720
            Width           =   1500
      ...
      Begin VB.PictureBox PicMenu 
         ...
         Index           =   2
         Left            =   3840
         MouseIcon       =   "FormPreparationDatabaseHistory.frx":28CD6
         MousePointer    =   99  'Custom
         ScaleHeight     =   1095
         ScaleWidth      =   1935
         TabIndex        =   19
         ...
         Begin VB.Image Image3 
            ...
            Index           =   2
            Left            =   720
            MouseIcon       =   "FormPreparationDatabaseHistory.frx":28FE0
            MousePointer    =   99  'Custom
            Picture         =   "FormPreparationDatabaseHistory.frx":292EA
            Top             =   180
            Width           =   480
         End
         Begin VB.Label Label2 
            ...
            Index           =   2
            Left            =   0
            MouseIcon       =   "FormPreparationDatabaseHistory.frx":2C6CC
            MousePointer    =   99  'Custom
            TabIndex        =   20
            Top             =   720
            Width           =   1890
      ...
      Begin VB.PictureBox PicMenu 
         ...
         Index           =   3
         Left            =   7680
         MouseIcon       =   "FormPreparationDatabaseHistory.frx":2C9D6
         MousePointer    =   99  'Custom
         ScaleHeight     =   1095
         ScaleWidth      =   1935
         TabIndex        =   17
         ...
         Begin VB.Image Image3 
            ...
            Index           =   3
            Left            =   720
            MouseIcon       =   "FormPreparationDatabaseHistory.frx":2CCE0
            MousePointer    =   99  'Custom
            Picture         =   "FormPreparationDatabaseHistory.frx":2CFEA
            Top             =   180
            Width           =   480
         End
         Begin VB.Label Label2 
            ...
            Index           =   3
            Left            =   0
            MouseIcon       =   "FormPreparationDatabaseHistory.frx":303CC
            MousePointer    =   99  'Custom
            TabIndex        =   18
            Top             =   720
            Width           =   1890
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.Label Lab 
         ...
         Index           =   1
         Left            =   12195
         MouseIcon       =   "FormPreparationDatabaseHistory.frx":306D6
         MousePointer    =   99  'Custom
         TabIndex        =   30
         Top             =   2580
         Width           =   1020
      ...
      Begin VB.Label Lab 
         ...
         Index           =   0
         Left            =   300
         MouseIcon       =   "FormPreparationDatabaseHistory.frx":309E0
         MousePointer    =   99  'Custom
         TabIndex        =   29
         Top             =   2580
         Width           =   930
      ...
      Begin VB.Image DefaultMenu 
         ...
         Index           =   11
         Left            =   480
         MouseIcon       =   "FormPreparationDatabaseHistory.frx":30CEA
         MousePointer    =   99  'Custom
         Picture         =   "FormPreparationDatabaseHistory.frx":30FF4
         Top             =   2040
         Width           =   480
      End
      Begin VB.Image DefaultMenu 
         ...
         Index           =   10
         Left            =   12480
         MouseIcon       =   "FormPreparationDatabaseHistory.frx":343D6
         MousePointer    =   99  'Custom
         Picture         =   "FormPreparationDatabaseHistory.frx":346E0
         Top             =   2040
         Width           =   480
      End
      Begin VB.Label lbDataFiltro 
         ...
         Index           =   1
         Left            =   7560
         MouseIcon       =   "FormPreparationDatabaseHistory.frx":37AC2
         MousePointer    =   99  'Custom
         TabIndex        =   11
         Top             =   960
         Width           =   4335
      ...
      Begin VB.Label lbDataFiltro 
         ...
         Index           =   0
         Left            =   1560
         MouseIcon       =   "FormPreparationDatabaseHistory.frx":37DCC
         MousePointer    =   99  'Custom
         TabIndex        =   10
         Top             =   960
         Width           =   4335
   ...
   Begin VB.Label Label4 
      ...
      Index           =   3
      Left            =   12120
      MouseIcon       =   "FormPreparationDatabaseHistory.frx":380D6
      MousePointer    =   99  'Custom
      TabIndex        =   54
      Top             =   9840
      Width           =   1230
   ...
   Begin VB.Label Label4 
      ...
      Index           =   2
      Left            =   5175
      MouseIcon       =   "FormPreparationDatabaseHistory.frx":383E0
      MousePointer    =   99  'Custom
      TabIndex        =   33
      Top             =   9840
      Width           =   1725
   ...
   Begin VB.Label Label4 
      ...
      Index           =   1
      Left            =   2655
      MouseIcon       =   "FormPreparationDatabaseHistory.frx":386EA
      MousePointer    =   99  'Custom
      TabIndex        =   32
      Top             =   9840
      Width           =   2235
   ...
   Begin VB.Label Label4 
      ...
      Index           =   0
      Left            =   255
      MouseIcon       =   "FormPreparationDatabaseHistory.frx":389F4
      MousePointer    =   99  'Custom
      TabIndex        =   31
      Top             =   9840
      Width           =   2115
   ...
   Begin VB.Label Text1 
      ...
      Index           =   0
      Left            =   4680
      MouseIcon       =   "FormPreparationDatabaseHistory.frx":38CFE
      MousePointer    =   99  'Custom
      TabIndex        =   3
      Top             =   1875
      Width           =   9585
   ...
   Begin VB.Label lbColonneGrid 
      ...
      Height          =   315
      Left            =   17430
      MouseIcon       =   "FormPreparationDatabaseHistory.frx":39008
      MousePointer    =   99  'Custom
      TabIndex        =   14
      Top             =   9840
      Width           =   1125
...
Call SetDatabasePreparationTable(GridDatabase)
Call SetQCperRecipeGrid(Grid2)
...
If lRow = 0 Then Exit Sub
    If PreparationFileName <> "" Then
        ...
        Call frmPreparation.DoShow(RecipeName, PreparationFileName, PreparationID, True)
    End If
...
Dim MyexcelName As String
    ...
    Select Case Index
        ...
        Case 1
            ...
            GridDatabase.ExportToExcel MyexcelName, True, True
...
Private Sub RiempiCombo()
    ...
    With CmbVisual
        ...
        .AddItem "Year"
        .AddItem "Archive"
        .ListIndex = 0 ' GetSetting(App.Title, Me.Name, "Filtro Data", 0)
...
If FirstRow > 0 Then
    ...
    PreparationID = GridDatabase.Cell(FirstRow, 14).Text
    PreparationFileName = GridDatabase.Cell(FirstRow, 13).Text
    bClosedPreparation = GridDatabase.Cell(FirstRow, 15).Text
    RecipeName = GridDatabase.Cell(FirstRow, 3).Text
    PicMenu(4).Visible = True
    PicMenu(5).Visible = True
    USER_PATH = IIf(bClosedPreparation, USER_PREPARATION_PATH & "Data\", USER_PREPARATION_PATH)
...
cont:
    ...
    With dbTabPreparation
        ...
        If Periodo <> "" Then
            ...
            .filter = "PrepDate>=#" & FormatDataLAT(Periodo) & "# " & sString
        Else
            .filter = "PrepDate>=#" & FormatDataLAT(CDate(dMyDA)) & "# AND PrepDate<=#" & FormatDataLAT(CDate(dMyA)) & "# " & sString
        ...
        '.Cell(0, 15).Text = ""
                   ...
                   ' FileName = IIf(IsNull(Trim(dbTabPreparation!RfpFileName)), "", Trim(dbTabPreparation!RfpFileName))
                   
        
                    .Cell(.Rows - 1, 0).Text = .Rows - 1
                    .Cell(.Rows - 1, 1).Text = IIf(IsNull(Trim(dbTabPreparation!Line)), "", Trim(dbTabPreparation!Line))
                    .Cell(.Rows - 1, 2).Text = IIf(IsNull(Trim(dbTabPreparation!HannaCode)), "", Trim(dbTabPreparation!HannaCode))
                    .Cell(.Rows - 1, 3).Text = IIf(IsNull(Trim(dbTabPreparation!Recipe)), "", Trim(dbTabPreparation!Recipe))
                    .Cell(.Rows - 1, 4).Text = IIf(IsNull(Trim(dbTabPreparation!Lot)), "", Trim(dbTabPreparation!Lot))
                    .Cell(.Rows - 1, 5).Text = IIf(IsNull(Trim(dbTabPreparation!Operator)), "", Trim(dbTabPreparation!Operator))
                    .Cell(.Rows - 1, 6).Text = IIf(IsNull(Trim(dbTabPreparation!PrepDate)), "", Trim(dbTabPreparation!PrepDate))
                    .Cell(.Rows - 1, 7).Text = IIf(IsNull(Trim(dbTabPreparation!PrepWeek)), "", Trim(dbTabPreparation!PrepWeek))
                    .Cell(.Rows - 1, 8).Text = IIf(IsNull(Trim(dbTabPreparation!numPrepWeek)), "", Trim(dbTabPreparation!numPrepWeek))
                    .Cell(.Rows - 1, 9).Text = IIf(IsNull(Trim(dbTabPreparation!QCOperator)), "", (Trim(dbTabPreparation!QCOperator)))
                    .Cell(.Rows - 1, 10).Text = IIf(IsNull(Trim(dbTabPreparation!Correction)), "", Trim(dbTabPreparation!Correction))
                    .Cell(.Rows - 1, 11).Text = IIf(IsNull(Trim(dbTabPreparation!CorrectionDate)), "", Trim(dbTabPreparation!CorrectionDate))
                    .Cell(.Rows - 1, 12).Text = IIf(IsNull(Trim(dbTabPreparation!Note)), "", Trim(dbTabPreparation!Note))
                    .Cell(.Rows - 1, 13).Text = IIf(IsNull(Trim(dbTabPreparation!FileName)), "", Trim(dbTabPreparation!FileName))
                    .Cell(.Rows - 1, 14).Text = dbTabPreparation!ID
                    .Cell(.Rows - 1, 15).Text = dbTabPreparation!bClosed
                    .Cell(.Rows - 1, 16).Text = dbTabPreparation!bIsMix
                    .Cell(.Rows - 1, 17).Text = IIf(IsNull(Trim(dbTabPreparation!ExpDate)), SetExpDate(dbTabPreparation!PrepDate, GetRecipeExp(Trim(dbTabPreparation!Recipe))), Trim(dbTabPreparation!ExpDate))
                    
                    If dbTabPreparation!bClosed Then
                        .Cell(.Rows - 1, 18).Text = IIf(IsNull(Trim(dbTabPreparation!QCDate)), "", Trim(dbTabPreparation!QCDate))
                    End If
                    
                    
                    
                      .Cell(.Rows - 1, 20).Text = IIf(IsNull(Trim(dbTabPreparation!QCStatus)), "", Trim(dbTabPreparation!QCStatus))
                      .Cell(.Rows - 1, 21).Text = IIf(IsNull(Trim(dbTabPreparation!QCDate)), "", Trim(dbTabPreparation!QCDate))
                      
                      .Cell(.Rows - 1, 22).Text = IIf(IsNull(Trim(dbTabPreparation!QtyToProduce)), "", Trim(dbTabPreparation!QtyToProduce))
                      .Cell(.Rows - 1, 23).Text = IIf(IsNull(Trim(dbTabPreparation!QtyProduced)), "", Trim(dbTabPreparation!QtyProduced))
                    
                    
                    If bCODLine Then
                        FileName = IIf(IsNull(Trim(dbTabPreparation!FileName)), "", Trim(dbTabPreparation!FileName))
                        .Cell(.Rows - 1, 24).Text = GetSFGLotPerRfp(FileName)
                    Else
                    ...
                    Select Case Trim(.Cell(.Rows - 1, 20).Text)
                        Case "Passed"
                            .Cell(.Rows - 1, 20).ForeColor = vbColorGreen
                            ' .Cell(.Rows - 1, 20).ForeColor = vbWhite
                        Case "Waiting"
                            .Cell(.Rows - 1, 20).ForeColor = vbColorTextDarkBlue
                        Case "Failed"
                            .Cell(.Rows - 1, 20).ForeColor = vbColorRed
                           ' .Cell(.Rows - 1, 20).ForeColor = vbWhite
                            
                            
                    End Select
                    .Cell(.Rows - 1, 20).Alignment = cellCenterCenter
...
ERR_END:
    On Error GoTo 0
    If Not (bCODLine) Then Grd.Column(24).Width = 0
...
Private Sub FillPreparationSpecifics()
    ...
    Label3 = "QC Specifics : " & RecipeName
    Grid2.Rows = 1
    Grid2.ZOrder
    GridDatabase.Visible = False
    Call GetQCPerRecipeInGrid7(Grid2, PreparationFileName)
