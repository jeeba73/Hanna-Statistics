...
Public bCLPClassification As Boolean
...
Public Sub Main()
    ...
    If rc Then
          With dbTabUserAccount
              ...
              If bExistAccount Then
                ...
                bExsistProductionManager = IIf(.EOF, False, True)
   ...
   bCLPClassification = GetSetting(App.Title, "Settings", "bCLPClassification", False)
   
         
If bCLPClassification Then
    
    F_MAIN_CLP.Timer1.Enabled = True
    F_MAIN_CLP.TimeriNTRO.Enabled = True
...
Private Function SetStartCLP(Optional Index As Integer = 0)
    
    F_MAIN_CLP.Show
    If MyOperatore.Name <> "" Then F_MAIN_CLP.Label2(6) = MyOperatore.Name
End Function
