...
picDraw.DrawStyle = 0
            ...
            If MySTDMax <> lngHeight / 2 And MySTDMax > 0 Then
                ...
                picDraw.Print "Max"
                picDraw.Line (OffLeft, MySTDMax)-(lngWidth + OffLeft / 2, MySTDMax), &H4080& ' vbRed ' mudtGraphProps.AxisColor
            End If
...
Dim Virgola As Integer
 ...
 picDraw.DrawStyle = 2
            ...
            If mudtGraphProps.s2 > 0 Then
                ...
                picDraw.Line (MySTDMax, 700)-(MySTDMax, lngHeight - 300), &H4080&  ' vbRed ' mudtGraphProps.AxisColor
