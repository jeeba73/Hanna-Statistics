...
Public Sub SetRecipeGrid(ByVal Grd As Grid, ByVal bValue As Boolean)
Dim i As Integer
        '------------------------------------------------
        '      RecipeForProduction  TABELLA Codici
        '------------------------------------------------
...
Private Sub SetMachineGrid(ByVal Grd As Grid)
Dim i As Integer
        '------------------------------------------------
    ...
    With Grd
      ...
      .Rows = 1
        ...
        .Cell(0, 1).Text = "Recipe"
        .Cell(0, 2).Text = "Line"
        .Cell(0, 3).Text = "Manchine"
        .Cell(0, 4).Text = "# Heads"
        .Cell(0, 5).Text = "Prod. speed ( pcs/min )"
        .Cell(0, 6).Text = "Est. time machine ( h )"
        .Cell(0, 7).Text = "Est. Shift machine ( S )"
...
Public Sub SetMaterialReqGrid(ByVal Grd As Grid, ByVal bPreparation As Boolean)
Dim i As Integer
        '------------------------------------------------
        '      RecipeForProduction  TABELLA Codici
        '------------------------------------------------
