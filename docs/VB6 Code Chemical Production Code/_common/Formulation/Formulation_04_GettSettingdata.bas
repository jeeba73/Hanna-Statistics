...
Public Function ReceiptGetSetting(ByRef iRecipeForProduction As RecipeForProduction, ByVal SettName As String) As Boolean
Dim rc As Boolean
...
Public Function GetRecipesFromFile(ByRef Recipes() As RecipeType, ByRef RecipeCount As Integer, ByVal SettingName As String, Optional ByVal bProduction As Boolean) As Boolean
    ...
    For i = 1 To RecipeCount
        ...
        rc = GetSingleRecipeFromFile(Recipes(Count), SettingName, i, bProduction)
        If bProduction Then
           If rc Then
            Count = Count + 1
            RecipeCount = Count - 1
...
Public Function GetSingleRecipeFromFile(ByRef Recipe As RecipeType, ByVal SettingName As String, ByVal i As Integer, Optional ByVal bProduction As Boolean) As Boolean
...
Dim i As Integer
    ...
    For i = 1 To PackagingCount
        ...
        With Packaging(i)
            ...
            .Head = GetSettingData(SettingName, "Packaging" & i, "Head", .Head)
            .Production = GetSettingData(SettingName, "Packaging" & i, "Production", .Production)
