...
Public Function SetAllProductionGrid(ByVal Grid As Variant) As Boolean


' 0 SetProductionCodeGrid
     Call SetProductionCodeGrid(Grid(0))
' 1 Acquisition
    Call SetProductionHistory(Grid(1))
...
Public Sub SetProductionCodeGrid(ByVal Grd As Grid)
Dim i As Integer
        '------------------------------------------------
...
Public Sub SetProductionHistory(ByVal Grd As Grid)
Dim i As Integer
        '------------------------------------------------
        '      RecipeForProduction  TABELLA Codici
        '------------------------------------------------
