...
Begin VB.Form F_GRAPH 
   ...
   EndProperty
   Icon            =   "F_GRAPH.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   Picture         =   "F_GRAPH.frx":6852
   ScaleHeight     =   12000
   ScaleMode       =   0  'User
   ScaleWidth      =   19200
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Image DefaultMenu 
         ...
         Index           =   5
         Left            =   9360
         MouseIcon       =   "F_GRAPH.frx":24D3F
         MousePointer    =   99  'Custom
         Picture         =   "F_GRAPH.frx":25049
         Top             =   6240
         Width           =   480
      End
   ...
   Begin VB.PictureBox PicMainMenu 
      ...
      Begin VB.PictureBox PicMenu 
         ...
         Begin VB.Image Image3 
            ...
            Index           =   0
            Left            =   735
            MouseIcon       =   "F_GRAPH.frx":287F1
            MousePointer    =   99  'Custom
            Picture         =   "F_GRAPH.frx":28AFB
            Top             =   180
            Width           =   480
         End
      ...
      Begin VB.PictureBox PicMenu 
         ...
         Begin VB.Image Image3 
            ...
            Index           =   1
            Left            =   735
            MouseIcon       =   "F_GRAPH.frx":2C7FB
            MousePointer    =   99  'Custom
            Picture         =   "F_GRAPH.frx":2CB05
            Top             =   180
            Width           =   480
         End
      End
   ...
   Begin VB.Image PicZOOM 
      ...
      Index           =   0
      Left            =   3840
      MouseIcon       =   "F_GRAPH.frx":3142D
      MousePointer    =   99  'Custom
      Picture         =   "F_GRAPH.frx":31737
      Top             =   11040
      Width           =   480
   End
   Begin VB.Image PicZOOM 
      ...
      Index           =   1
      Left            =   5160
      MouseIcon       =   "F_GRAPH.frx":34B19
      MousePointer    =   99  'Custom
      Picture         =   "F_GRAPH.frx":34E23
      Top             =   11040
      Width           =   480
   End
   Begin VB.Label L 
   ...
   End
   Begin VB.Image DefaultMenu 
      DragIcon        =   "F_GRAPH.frx":38E2D
      Height          =   480
      Index           =   0
      Left            =   18240
      MouseIcon       =   "F_GRAPH.frx":3C20F
      MousePointer    =   99  'Custom
      Picture         =   "F_GRAPH.frx":3C519
      Top             =   11040
      Width           =   480
   End
   Begin VB.Image DefaultMenu 
      ...
      Index           =   3
      Left            =   480
      MouseIcon       =   "F_GRAPH.frx":3F8FB
      MousePointer    =   99  'Custom
      Picture         =   "F_GRAPH.frx":3FC05
      Top             =   11040
      Width           =   480
   End
   Begin VB.Image DefaultMenu 
      DragIcon        =   "F_GRAPH.frx":42FE7
      Height          =   480
      Index           =   1
      Left            =   9360
      MouseIcon       =   "F_GRAPH.frx":463C9
      MousePointer    =   99  'Custom
      Picture         =   "F_GRAPH.frx":466D3
      Top             =   11040
      Width           =   480
   End
   Begin VB.Image DefaultMenu 
      ...
      Index           =   2
      Left            =   15960
      MouseIcon       =   "F_GRAPH.frx":49AB5
      MousePointer    =   99  'Custom
      Picture         =   "F_GRAPH.frx":49DBF
      Top             =   11040
      Width           =   480
   End
   Begin VB.Image DefaultMenu 
      ...
      Index           =   4
      Left            =   5880
      MouseIcon       =   "F_GRAPH.frx":4D1A1
      MousePointer    =   99  'Custom
      Picture         =   "F_GRAPH.frx":4D4AB
      Top             =   11040
      Visible         =   0   'False
      Width           =   480
   End
...
sString = IIf(bAllValue, "_A", "_S")
GetMaxY (INDEX_STD)
Call Dati_Lotto(INDEX_STD)

    Select Case IndexFormProcedura
        Case 0
            PdfFileName = FormatNomeFile_ATP(Text1(0) & "_" & Text1(1) & "_ST" & cmbSTD & "_QCMean" & sString)
        Case 1
            PdfFileName = FormatNomeFile_ATP(Text1(0) & "_" & Text1(1) & "_ST" & cmbSTD & "_QCGauss" & sString)
    End Select
End Sub
                ...
                Else
                    If (.STDtest(Index).Readings(a).bSelectedValue) Or bAllValue Then
                       ...
                       ' MyGraphicCheck.STDtest(Index) = .STDtest(Index)
                        ...
                        TestNumber = .STDtest(Index).Readings(a).Test
                        If MaxValue(Index) < RealValue Then
                            MaxValue(Index) = RealValue
                        End If
                        
                        AddPoint PointValue, CInt(.STDtest(Index).Readings(a).Meter), RealValue, TestNumber
       ...
       ' Graph1.MeanValue =
        ...
        For j = -2000 To 2000
           ...
           'xData = STD(absIndex, 3) * ((j / 1000) + 1)
            ...
            'RealValue = FormatNumber(xData, virgola) ' yData 'CDbl(.STDTest(Index).Readings(j).Value)
            RealValue = xData '
...
Private Sub AddPoint(ByVal Value As Double, ByVal i As Integer, ByVal RealValue As Double, Optional ByVal TestNumber As Integer)
...
Dim blnRedraw   As Boolean
    ...
    With Graph1
        ...
        Select Case mlngStyle
            ...
            Case Else
                lngValue = Value
                .Points.Add lngValue, i, RealValue, TestNumber
    ...
    With Graph1
       ...
       ' .X0Value = X0Value(INDEX_STD)
        ...
        If bPrintMe Then
            ...
            .PointColor = vbBlack ' RGB(255, 0, 0)
