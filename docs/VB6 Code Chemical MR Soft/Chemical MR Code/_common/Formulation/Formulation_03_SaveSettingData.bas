...
Public Function ReceiptSaveSetting(ByRef iRecipeForSTDPreparation As RecipeForSTDPreparation, ByVal SettName As String) As Boolean
Dim rc As Boolean
...
On Error GoTo ERR_SAVE
    ...
    With iRecipeForSTDPreparation
        ...
        SaveSettingData SettingName, "iRecipeForSTDPreparation", "fileNameRecForProd", SettingName
...
For i = 1 To RecipeCount
    ...
    With Recipes(i)
        ...
        'SaveSettingData SettingName, "Recipes" & i, "STDPreparationWay.EsttimeD", .STDPreparationWay.EsttimeD
        'SaveSettingData SettingName, "Recipes" & i, "STDPreparationWay.EstTimeH", .STDPreparationWay.EstTimeH
        'SaveSettingData SettingName, "Recipes" & i, "STDPreparationWay.Line", .STDPreparationWay.Line
        'SaveSettingData SettingName, "Recipes" & i, "STDPreparationWay.STDPreparation", .STDPreparationWay.STDPreparation
        'SaveSettingData SettingName, "Recipes" & i, "STDPreparationWay.Speed", .STDPreparationWay.Speed
...
Dim i As Integer
    For i = 1 To PackagingCount
        ...
        With Packaging(i)
            ...
            SaveSettingData SettingName, "Packaging" & i, "STDPreparation", .STDPreparation
