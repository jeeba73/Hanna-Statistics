...
Public Function FillGridRfPFromFile(ByVal Grid As Grid, ByRef uRecipeForSTDPreparation As RecipeForSTDPreparation, ByVal Index As Integer)
...
Dim i As Integer
    ...
    Select Case Index
        Case 1
            ' Hanna Codes
            Call GetCodeGrid(Grid, uRecipeForSTDPreparation)
        Case 2
            ' Recipes
            Call GetRecipeGrid(Grid, uRecipeForSTDPreparation)
        Case 3
            ' Components
        Case 4
            ' totals
            Call GetTotalsGrid(Grid, uRecipeForSTDPreparation)
        Case 5
            ' Bottling / Packaging
            Call GetPackagingGrid(Grid, uRecipeForSTDPreparation)
...
Private Sub GetCodeGrid(ByVal Grid As Grid, ByRef uRecipeForSTDPreparation As RecipeForSTDPreparation)
Dim i As Integer
...
Private Sub GetRecipeGrid(ByVal Grid As Grid, ByRef uRecipeForSTDPreparation As RecipeForSTDPreparation)
Dim i As Integer
...
Private Sub GetTotalsGrid(ByVal Grid As Grid, ByRef uRecipeForSTDPreparation As RecipeForSTDPreparation)
Dim i As Integer
...
Private Sub GetPackagingGrid(ByVal Grid As Grid, ByRef uRecipeForSTDPreparation As RecipeForSTDPreparation)
Dim i As Integer
        '------------------------------------------------
      ...
      .Rows = 1
        ...
        With uRecipeForSTDPreparation
            ...
            For i = 1 To .PackagingCount
                ...
                Grid.Cell(i, 3).Text = .Packaging(i).STDPreparation
                Grid.Cell(i, 4).Text = .Packaging(i).Speed
                Grid.Cell(i, 5).Text = .Packaging(i).EstTimeH
                Grid.Cell(i, 6).Text = .Packaging(i).EsttimeD
