...
Option Explicit
Public Function SetGridChemicalMR(ByRef Grd1 As Grid) As Boolean
...
Public Function SetGridEditChemicalMR(ByRef Grd As Grid) As Boolean
    ...
    End With
End Function
Public Sub CopyChemicalMRGrd1(ByRef Grd As Grid, Optional ByVal Code As String, Optional bMainForm As Boolean, Optional ByVal sString As String, Optional ByVal bMixes As Boolean, Optional ByVal bOnlyCriticals As Boolean)
Dim i As Integer
Dim t As Integer
...
Public Sub CopyChemicalMRGrd2(ByVal Grd2 As Grid, ByVal lId As Long)
Dim i As Integer
Dim t As Integer
...
Public Sub Grd2_ChemicalMR_LeaveCell(ByVal Grd2 As Grid, ByVal Row As Long, ByVal Col As Long, NewRow As Long, NewCol As Long, Cancel As Boolean, ByVal lRow As Long)
...
Public Function SaveDatabaseChemicalMR(ByVal Grd2 As Grid) As Boolean
Dim rc As Boolean
...
Public Sub AddComboChemicalMR(ByVal Combo1 As ComboBox)
    Combo1.Clear
    Combo1.AddItem "Code"
    Combo1.ListIndex = 0
End Sub
