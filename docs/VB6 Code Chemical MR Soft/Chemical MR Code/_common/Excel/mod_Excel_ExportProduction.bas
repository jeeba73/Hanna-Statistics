...
Public Function EsportaSTDPreparationExcel(ByVal FileName As String, ByVal sString As String, ByRef iSTDPreparation As RecipeForSTDPreparation) As Boolean
    Dim rc As Boolean
    On Error GoTo ERR_IMP
    rc = True
   ' MsgBox USER_DESKTOP & "\" & "Backup VerPeriodica.xls"
   uSTDPreparation = iSTDPreparation
   ...
   If SettingName = "" Then Exit Function
        ...
        If CreateExcel(False) Then
            ...
            If CopyChemicalMRData(SettingName) Then
...
Public Function CopyChemicalMRData(ByVal SettingName As String) As Boolean
Dim rc As Boolean
Dim i As Integer
...
With uSTDPreparation
    ...
    Call AddValue(Riga + 2, 2, "STDPreparation", True, True)
   ...
   ' Call AddValue(Riga + 3, 2, "Recipe for STDPreparation/Preparation Details", True)
...
On Error GoTo ERR_GET:
    ...
    Call AddValue(Riga - 1, 2, "STDPreparation Notes", True, True)
