...
Dim rc As Boolean
 '------------------------------------------------------------
    ...
    MyPathLabel_Brother = GetSetting(App.Title, "PATH", "TEMPLATE LABEL", App.PATH & "\ETICHETTA.lbx")
    ...
    If bStampanteSelezionata Then
        ...
        If GetSetting(App.Title, "LABEL PRINTER", "bUtilizzo", True) Then
            PRINTERNAME = GetSetting(App.Title, "LABEL PRINTER", "NAME", "")
