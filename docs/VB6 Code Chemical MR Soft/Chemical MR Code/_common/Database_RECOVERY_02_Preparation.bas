...
Private uPreparation As RecipeForSTDPreparation
...
cont:
        bIfDataPath = IIf(USER_PATH = USER_SCHEDULED_STD_PATH & "data\", True, False)
        ...
        If USER_PATH = USER_SCHEDULED_STD_PATH Then GoTo closed
    ...
    dbTabAcquisition.Open "SELECT *  FROM TabAcquisition order by index ", dbChemicalMR, adOpenKeyset, adLockOptimistic, adCmdText
...
Public Function PreparationRecoveryGetSetting(ByRef iPreparation As RecipeForSTDPreparation, ByVal SettName As String) As Boolean
Dim rc As Boolean
...
On Error GoTo ERR_SAVE
    ...
    With iPreparation
        ...
        .bCorrection = GetSettingData(SettingName, "iRecipeForSTDPreparation", "bCorrection", .bCorrection)
        
        .OperatorPrep = GetSettingData(SettingName, "iRecipeForSTDPreparation", "OperatorPrep", .OperatorPrep)
        .OperatorRfP = GetSettingData(SettingName, "iRecipeForSTDPreparation", "OperatorRfP", .OperatorRfP)
