...
Public Function DeleteRecipeForSTDPreparation(ByVal ID As Long, ByVal FileName As String) As Boolean
Dim rc As Boolean
...
rc = False
    ...
    With dbTabReceiptForSTDPreparation
        ...
        Else
            ...
            .Update
            .Close
            .Open "SELECT *  FROM TabReceiptForSTDPreparation order by id ", dbChemicalMR, adOpenKeyset, adLockOptimistic, adCmdText
        End If
...
ERR_END:
    On Error GoTo 0
    DeleteRecipeForSTDPreparation = rc
    Exit Function
ERR_DELETE:
    rc = False
...
Dim RowsCount As Integer
    ...
    SaveSettingData SettingName, "ScheduledSTD", "Recipe", Trim(RecipeName)
    SaveSettingData SettingName, "ScheduledSTD", "RecipeIndex", Index
...
On Error GoTo ErrSetPrepRec
    ...
    With dbTabReceiptForSTDPreparation
        ...
        Else
            ...
            SaveSettingData FileName, "dbTabReceiptForSTDPreparation", "ID", !ID
...
TryAgaing:
    ...
    SaveSettingData FileName, "ScheduledSTD", "Recipe", Trim(RecipeName)
    SaveSettingData FileName, "iRecipeForSTDPreparation", "fileName", Trim(FileName)
    CloseSettingDataFile
    
    If FileExists(USER_PATH & FileName) Then
        FileCopy USER_PATH & FileName, USER_SCHEDULED_STD_PATH & NewFileName
    End If
...
TryAgaingMix:
            ...
            With dbTabPreparation
                ...
                .filter = "FileName ='" & NewFileName & "' and bClosed=false"
                If .EOF Then
                    If F_MsgBox.DoShow("Mix in Recipe for STDPreparation." & vbCrLf & "Set Preparation for this Mix with Quantity : " & QtyKg & " kg", RecipeCode) = False Then GoTo cont
...
Public Function CloseRecipeForSTDPreparation(ByVal FileName As String, ByVal Path As String) As Boolean
Dim rc As Boolean
...
On Error GoTo ErrSetPrepRec
    ...
    SaveSettingData FileName, "iRecipeForSTDPreparation", "bOpen", False, Path
...
ERR_END:
    On Error GoTo 0
    CloseRecipeForSTDPreparation = rc
    Exit Function
ErrSetPrepRec:
    rc = False
    MsgBox err.Description
...
Public Function IfRecipeForSTDPreparationHasAllMixes(ByRef uRecipe() As RecipeType)
Dim rc As Boolean
Dim mrc As Boolean
...
Dim i As Integer
    ...
    Next
    rc = mrc
    IfRecipeForSTDPreparationHasAllMixes = rc
End Function
