   ...
   Begin VB.PictureBox PicMainMenu 
      ...
      Begin VB.PictureBox PicMenu 
         ...
         Begin VB.Image Image3 
            ...
            Index           =   4
            Left            =   720
            MouseIcon       =   "FormMRCode.frx":E9A0
            MousePointer    =   99  'Custom
            Picture         =   "FormMRCode.frx":ECAA
            Top             =   180
            Width           =   480
         End
      End
      Begin VB.PictureBox PicMenu 
         ...
         Index           =   0
         Left            =   0
         MouseIcon       =   "FormMRCode.frx":1208C
         MousePointer    =   99  'Custom
         ScaleHeight     =   1095
         ScaleWidth      =   1935
         TabIndex        =   12
         ...
         Begin VB.Image Image3 
            ...
            Index           =   0
            Left            =   720
            MouseIcon       =   "FormMRCode.frx":12396
            MousePointer    =   99  'Custom
            Picture         =   "FormMRCode.frx":126A0
            Top             =   180
            Width           =   480
         End
         Begin VB.Label Label2 
            ...
            Index           =   0
            Left            =   90
            MouseIcon       =   "FormMRCode.frx":15A82
            MousePointer    =   99  'Custom
            TabIndex        =   13
            Top             =   720
            Width           =   1830
      ...
      Begin VB.PictureBox PicMenu 
         ...
         Index           =   1
         Left            =   1920
         MouseIcon       =   "FormMRCode.frx":15D8C
         MousePointer    =   99  'Custom
         ScaleHeight     =   1095
         ScaleWidth      =   1935
         TabIndex        =   10
         ...
         Begin VB.Image Image3 
            ...
            Index           =   1
            Left            =   720
            MouseIcon       =   "FormMRCode.frx":16096
            MousePointer    =   99  'Custom
            Picture         =   "FormMRCode.frx":163A0
            Top             =   180
            Width           =   480
         End
         Begin VB.Label Label2 
            ...
            Index           =   1
            Left            =   90
            MouseIcon       =   "FormMRCode.frx":19782
            MousePointer    =   99  'Custom
            TabIndex        =   11
            Top             =   720
            Width           =   1830
      ...
      Begin VB.PictureBox PicMenu 
         ...
         Index           =   2
         Left            =   3840
         MouseIcon       =   "FormMRCode.frx":19A8C
         MousePointer    =   99  'Custom
         ScaleHeight     =   1095
         ScaleWidth      =   1935
         TabIndex        =   8
         ...
         Begin VB.Image Image3 
            ...
            Index           =   2
            Left            =   720
            MouseIcon       =   "FormMRCode.frx":19D96
            MousePointer    =   99  'Custom
            Picture         =   "FormMRCode.frx":1A0A0
            Top             =   180
            Width           =   480
         End
         Begin VB.Label Label2 
            ...
            Index           =   2
            Left            =   0
            MouseIcon       =   "FormMRCode.frx":1D482
            MousePointer    =   99  'Custom
            TabIndex        =   9
            Top             =   720
            Width           =   1890
      ...
      Begin VB.PictureBox PicMenu 
         ...
         Index           =   3
         Left            =   5760
         MouseIcon       =   "FormMRCode.frx":1D78C
         MousePointer    =   99  'Custom
         ScaleHeight     =   1095
         ScaleWidth      =   1935
         TabIndex        =   6
         ...
         Begin VB.Image Image3 
            ...
            Index           =   3
            Left            =   720
            MouseIcon       =   "FormMRCode.frx":1DA96
            MousePointer    =   99  'Custom
            Picture         =   "FormMRCode.frx":1DDA0
            Top             =   180
            Width           =   480
         End
         Begin VB.Label Label2 
            ...
            Index           =   3
            Left            =   0
            MouseIcon       =   "FormMRCode.frx":21182
            MousePointer    =   99  'Custom
            TabIndex        =   7
            Top             =   720
            Width           =   1890
...
With Grd2
    ...
    .Cell(4, 2).Text = IIf(IsNull(Trim(dbTabCode!Recipe)), "", Trim(dbTabCode!Recipe))      '& "MRCode"
    ...
    .Cell(9, 2).Text = IIf(IsNull(Trim(dbTabCode!ParameterFormula)), "", Trim(dbTabCode!ParameterFormula))      '& "Hanna Formula"
    ...
    .Cell(14, 2).Text = Int(IIf(IsNull(Trim(dbTabCode!Decimal)), "0", Trim((dbTabCode!Decimal))))      '& "Decimal"
  ...
  '  .Cell(20, 2).Text = IIf(IsNull(Trim(dbTabCode!STDMR)), "", Trim(dbTabCode!STDMR))      '& "STDMR "
   ...
   ' .Cell(61, 2).Text = IIf(sString = True, "Yes", "No")    '& "Certified"
    ...
    '    .Cell(i, 2).ForeColor = vbColorForeFixed  ' vbColorBlueProgram
