...
Begin VB.Form F_SETTING 
   ...
   Begin VB.PictureBox PicMain 
      ...
      Begin VB.Image DisableImage 
         ...
         Index           =   1
         Left            =   9360
         MouseIcon       =   "F_SETTING.frx":21FD0
         MousePointer    =   99  'Custom
         Picture         =   "F_SETTING.frx":222DA
         Top             =   6840
         Width           =   480
      End
   End
   ...
   Begin VB.PictureBox PicMain 
      ...
      Begin VB.Image DefaultMenu 
         ...
         Index           =   6
         Left            =   16560
         MouseIcon       =   "F_SETTING.frx":2EBEA
         MousePointer    =   99  'Custom
         Picture         =   "F_SETTING.frx":2EEF4
         Top             =   2760
         Width           =   480
      End
      Begin VB.Label Label1 
      ...
      Begin VB.Image DisableImage 
         ...
         Index           =   2
         Left            =   9360
         MouseIcon       =   "F_SETTING.frx":325E0
         MousePointer    =   99  'Custom
         Picture         =   "F_SETTING.frx":328EA
         Top             =   5400
         Visible         =   0   'False
         Width           =   480
      End
   ...
   Begin VB.PictureBox PicMainMenu 
      ...
      Begin VB.PictureBox PicMenu 
         ...
         Begin VB.Image Image3 
            ...
            Index           =   4
            Left            =   720
            MouseIcon       =   "F_SETTING.frx":55740
            MousePointer    =   99  'Custom
            OLEDropMode     =   1  'Manual
            Picture         =   "F_SETTING.frx":55A4A
            Top             =   120
            Width           =   480
         End
      End
      Begin VB.PictureBox PicMenu 
         ...
         Begin VB.Image Image3 
            ...
            Index           =   3
            Left            =   735
            MouseIcon       =   "F_SETTING.frx":59136
            MousePointer    =   99  'Custom
            OLEDropMode     =   1  'Manual
            Picture         =   "F_SETTING.frx":59440
            Top             =   120
            Width           =   480
         End
         Begin VB.Label Label2 
      ...
      Begin VB.PictureBox PicMenu 
         ...
         Begin VB.Image Image3 
            ...
            Index           =   2
            Left            =   720
            MouseIcon       =   "F_SETTING.frx":5CE36
            MousePointer    =   99  'Custom
            Picture         =   "F_SETTING.frx":5D140
            Top             =   120
            Width           =   480
         End
         Begin VB.Label Label2 
      ...
      Begin VB.PictureBox PicMenu 
         ...
         Begin VB.Image Image3 
            ...
            Index           =   1
            Left            =   720
            MouseIcon       =   "F_SETTING.frx":60B36
            MousePointer    =   99  'Custom
            Picture         =   "F_SETTING.frx":60E40
            Top             =   120
            Width           =   480
         End
         Begin VB.Label Label2 
      ...
      Begin VB.PictureBox PicMenu 
         ...
         Begin VB.Image Image3 
            ...
            Index           =   0
            Left            =   720
            MouseIcon       =   "F_SETTING.frx":64B40
            MousePointer    =   99  'Custom
            Picture         =   "F_SETTING.frx":64E4A
            Top             =   120
            Width           =   480
         End
      End
   ...
   End
   Begin VB.Image DefaultMenu 
      DragIcon        =   "F_SETTING.frx":69A7C
      Height          =   480
      Index           =   0
      Left            =   18240
      MouseIcon       =   "F_SETTING.frx":6CE5E
      MousePointer    =   99  'Custom
      Picture         =   "F_SETTING.frx":6D168
      Top             =   11160
      Width           =   480
   End
   Begin VB.Line Line2 
   ...
   Begin VB.Image DefaultMenu 
      ...
      MousePointer    =   99  'Custom
      Picture         =   "F_SETTING.frx":70854
      Top             =   11160
      Width           =   480
   End
   Begin VB.Image DefaultMenu 
      DragIcon        =   "F_SETTING.frx":73C36
      Height          =   480
      Index           =   1
      Left            =   9360
      MouseIcon       =   "F_SETTING.frx":77018
      MousePointer    =   99  'Custom
      Picture         =   "F_SETTING.frx":77322
      Top             =   11160
      Width           =   480
   End
   Begin VB.Image DefaultMenu 
      ...
      Index           =   2
      Left            =   15960
      MouseIcon       =   "F_SETTING.frx":7A704
      MousePointer    =   99  'Custom
      Picture         =   "F_SETTING.frx":7AA0E
      Top             =   11160
      Width           =   480
   End
   Begin VB.Image DefaultMenu 
...
PopupMessage 2, "Warning : Only Line Leader ot TCO can Operate" & vbCrLf & "Please Login...", , True
CheckPrivilege 1
CheckUser (Index)
...
Select Case Index
    ...
    Case 5
        ...
        Frame3(1).BackColor = vbColorBlueProgram
...
For i = 0 To PicMenu.Count - 1
    If i = Index Then
        PicMenu(i).BackColor = PicInfo(i).BackColor
...
'Picture1(4).BackColor = vbColorBlueProgram
'Line3(4).BorderColor = vbColorBlueProgram 'vbColorTextBlue
...
Private Sub SetFormSeparator(ByVal rc As Boolean)
         If rc Then
            ...
            QrCodeLabel(1).ForeColor = vbColorBlueProgram
            
         Else
         
            QrCodeLabel(1) = "Barcode Reader : Please Set Separator Character"
            QrCodeLabel(1).ForeColor = vbColorRed
