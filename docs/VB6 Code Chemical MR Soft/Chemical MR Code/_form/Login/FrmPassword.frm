   ...
   Begin VB.PictureBox PicMainMenu 
      ...
      Begin VB.PictureBox PicMenu 
         ...
         Begin VB.Label Label2 
            ...
            Index           =   0
            Left            =   465
            MouseIcon       =   "FrmPassword.frx":AAD8
            MousePointer    =   99  'Custom
            TabIndex        =   14
            Top             =   660
            Width           =   1080
      ...
      Begin VB.PictureBox PicMenu 
         ...
         Begin VB.Image Image3 
            ...
            Index           =   2
            Left            =   720
            MouseIcon       =   "FrmPassword.frx":F0F6
            MousePointer    =   99  'Custom
            Picture         =   "FrmPassword.frx":F400
            Top             =   120
            Width           =   480
         End
      End
...
Public Function DoShow(Optional ByVal IndPrivilege As Boolean, Optional ByVal User As String, Optional ByVal Passw As String) As Boolean
    ...
    With dbTabUserAccount
        ...
        If .EOF Then
            ...
            SetFormPrivilege (1)
        Else
            bExsistSTDPreparationManager = True
        End If
        .Filter = ""
    ...
    If Operatore <> "" Then
        ...
        With dbTabUserAccount
            ...
            Else
                ...
                UserPrivilege = IIf(IsNull(Trim(!IndexPrivilege)), 0, Trim(!IndexPrivilege))
                If bCambioPrivilegi Then IndexPrivilege = IIf(IsNull(Trim(!IndexPrivilege)), 0, Trim(!IndexPrivilege))
                SetFormPrivilege (UserPrivilege)
                
                If bCambioPrivilegi Then
                    If IndexPrivilege = 1 Then
                        Label1(3) = "Production Manager"
                        Check2.Value = 1
                    End If
                    If IndexPrivilege = 2 Then
                        Check3.Value = 1
                        Label1(3) = "Line Leader"
                    End If
                    
                    If IndexPrivilege = 3 Then
                        Check1.Value = 1
                        Label1(3) = "Administrator Account"
                    End If
                End If
...
Check3.ForeColor = IIf(Check3.Value = 1, vbColorOrange, &H404040)
...
Check1.ForeColor = IIf(Check1.Value = 1, vbColorOrange, &H404040)
...
Check2.ForeColor = IIf(Check2.Value = 1, vbColorOrange, &H404040)
    ...
    With dbTabUserAccount
        ...
        Else
            ...
            For a = 1 To .RecordCount
                ...
                indexP = IIf(IsNull(Trim(!IndexPrivilege)), 0, Trim(!IndexPrivilege))
                With GrdAccount
                    .AddItem "", False
                    .Cell(.Rows - 1, 0).Text = a
                    .Cell(.Rows - 1, 1).Text = Trim(dbTabUserAccount!UserID)
                    .Cell(.Rows - 1, 2).Text = GetPosition(indexP)
                End With
...
SaveSetting App.Title, "Settings", "utilizza_pass", pass_ok
 pass_ok.ForeColor = IIf(pass_ok.Value = 1, vbColorOrange, &H404040)
End Sub
