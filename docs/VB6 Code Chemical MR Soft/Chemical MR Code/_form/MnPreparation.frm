...
Begin VB.Form frmPreparation_Manual 
   Appearance      =   0  'Flat
   BackColor       =   &H80000005&
   Caption         =   "Chemical MR"
   ClientHeight    =   11880
      ...
      Begin VB.PictureBox PBContainer 
         ...
         Begin VB.Frame frInside 
            ...
            Begin VB.Image ImCode 
               ...
               Index           =   4
               Left            =   9120
               Picture         =   "MnPreparation.frx":29F2
               ToolTipText     =   "4000"
               Top             =   7440
               Width           =   240
            End
            Begin VB.Image ImCode 
               ...
               Index           =   5
               Left            =   7320
               Picture         =   "MnPreparation.frx":33F4
               ToolTipText     =   "4000"
               Top             =   7440
               Width           =   240
            End
         ...
         Begin VB.Frame frInside 
            ...
            Begin VB.Frame Frame3 
               ...
               Begin VB.Label lbInside 
                  ...
                  AutoSize        =   -1  'True
                  BackStyle       =   0  'Transparent
                  Caption         =   "MR : Acquisition Details"
                  BeginProperty Font 
                     Name            =   "Century Gothic"
                     Size            =   24
                     Charset         =   0
         ...
         Begin VB.Frame frInside 
            ...
            Begin VB.Frame frExcel 
               ...
               Begin VB.Image Image 
                  ...
                  MousePointer    =   99  'Custom
                  OLEDropMode     =   1  'Manual
                  Picture         =   "MnPreparation.frx":3DF6
                  Top             =   0
                  Width           =   480
               End
            ...
            Begin VB.Image Image2 
               Height          =   360
               Left            =   5040
               Picture         =   "MnPreparation.frx":71D8
               Top             =   3000
               Width           =   360
            End
            Begin VB.Label lbFormulation 
   ...
   Begin VB.PictureBox PBFooter 
      ...
      Begin VB.Image DefaultMenu 
         ...
         Left            =   9360
         MousePointer    =   99  'Custom
         Picture         =   "MnPreparation.frx":8C4A
         Top             =   120
         Width           =   480
      End
      Begin VB.Image DefaultMenu 
         ...
         Left            =   15600
         MousePointer    =   99  'Custom
         Picture         =   "MnPreparation.frx":C02C
         Top             =   120
         Width           =   480
      End
      Begin VB.Image DefaultMenu 
         ...
         Left            =   18240
         MousePointer    =   99  'Custom
         Picture         =   "MnPreparation.frx":F40E
         Top             =   120
         Width           =   480
      End
   ...
   Begin VB.PictureBox PBTitle 
      ...
      Begin VB.PictureBox PicMenu 
         ...
         Begin VB.Image Image3 
            ...
            Left            =   840
            MousePointer    =   99  'Custom
            Picture         =   "MnPreparation.frx":127F0
            Top             =   120
            Width           =   480
         End
   ...
   End
End
Attribute VB_Name = "frmPreparation_Manual"
...
Private AcquisitionMR As String
...
Public Function DoShow(ByVal HannaCode As String, ByVal FileName As String, Optional ByVal Preparation_ID As Long, Optional bClosed As Boolean, Optional bDoClosePreparation As Boolean) As Boolean
    ...
    lbMRUnit = GetSetting(App.Title, "Preparation", "STDUnit", "mg/L")
...
'
'                    Case 1
'                        uRecipe.STD(lSTDRow).MRCode = (strSTD)
'                    'Case 2
...
UserSTDValue = 9999
    ...
    frCommandInside(28).Visible = False
    
     QRCode = QRCode01Clean
    
    If FirstRow > 0 Then
            lSTDRow = FirstRow
            MRCode = Trim(Grid1.Cell(FirstRow, 1).Text)
            
            uRecipe.Code = MRCode
            
            UserSTDValue = IIf(IsNull(Trim(Grid1.Cell(FirstRow, 4).Text)) Or Trim(Grid1.Cell(FirstRow, 4).Text) = "", 9999, Trim(Grid1.Cell(FirstRow, 4).Text))
            frCommandInside(5).Visible = IIf(MRCode <> "", True, False)
            lSTDCol = FirstCol
      
            frCommandInside(28).Visible = IIf(Trim(Grid1.Cell(FirstRow, 5).Text) > 0, True, False)
            
            With QRCode
                .Code = uPreparation.HannaCode.Code
                .ID = Trim(Grid1.Cell(FirstRow, 10).Text)
                .Date = FormatDataLAT(FormatDateTime(Now(), vbShortDate))
                .Time = (FormatDateTime(Now(), vbShortTime))
                .Text3 = "STD Production"
                .STDn = MRCode
                .STDv = IIf(IsNull(Trim(Grid1.Cell(FirstRow, 2).Text)) Or Trim(Grid1.Cell(FirstRow, 2).Text) = "", 9999, Trim(Grid1.Cell(FirstRow, 2).Text))
                .Note = Trim(Grid1.Cell(FirstRow, 9).Text)
...
If FirstRow > 0 Then
    ...
    AcquisitionMR = Grid2.Cell(FirstRow, 3).Text
...
Dim ID As Long
 ...
 With Grid3
    If lRowBottle > 0 Then
        ...
        If F_MsgBox.DoShow("Select bottle?", "Bottle : " & .Cell(lRowBottle, 3).Text) Then
        
            ID = Grid3.Cell(lRowBottle, 20).Text
             
            
            ReDim uBottle(0)
            
        '--------------------------------------------------------------------------------
        '   devo modificare la QTY
        '   uPreparation.Recipe.STD(i).TheoreticalWeight
        '   Liquidi :
        '   fattore = (1000/MRVALUE) da moltiplicare per MR Qty
        '   Solidi:
        '   fattore = (Purity Teorica / Purity Bottiglia) da moltiplicare per MR Qty
        '--------------------------------------------------------------------------------
...
IDBottle = Grid3.Cell(lRowBottle, 20).Text
...
Private Sub Grid6_SelChange(ByVal FirstRow As Long, ByVal FirstCol As Long, ByVal LastRow As Long, ByVal LastCol As Long)
    ...
    userAcquisition.PipettaType = ""
    If FirstRow > 0 Then
        userAcquisition.PipettaType = Grid6.Cell(FirstRow, 1).Text
...
Private Sub lbMRStock_Change()
lbMR_Unit = lbMRStock
End Sub

Private Sub lbMRUnit_Click()

' unit
Dim strUnit As String

    strUnit = GetSetting(App.Title, "Preparation", "STDUnit", "mg/L")
    If F_InputBox.DoShow("Enter Unit :", "STD Value Unit", , , , strUnit) Then
        lbMRUnit = strUnit
        SaveSetting App.Title, "Preparation", "STDUnit", strUnit
...
End With
 ...
 With uPreparation
        ...
        txFormulation(11) = .ManualValue
        txFormulation(18) = .STD_Manual_ID
        lbMRUnit = IIf(.ManualUnit = "", "mg/L", .ManualUnit)
...
Private Sub SetHannaCodeDataPreparation()
    ...
    With uPreparation
        ...
        .ManualValue = txFormulation(11)
        .STD_Manual_ID = txFormulation(18)
        .ManualUnit = lbMRUnit
    ...
    With uPreparation.HannaCode
        ...
        .STDMatrix = txFormulation(2)
        .STDStorage = txFormulation(9)
        .Code = txFormulation(14)
        .Description = txFormulation(3)
        
        If .STDExp <> "" And IsDate(uPreparation.DataPrep) Then
            .STDExpDate = FormatDataLAT(DateAdd("d", .STDExp, uPreparation.DataPrep))
        End If
...
Private Sub InitForm()
   ...
   Call SetGridNotes(Grid4)
    ...
    Call SetAllPreparationGrid(Grid(), True)
    Call SetColumnWidth
  ...
  With uPreparation
   ...
   ' inizializzo la "ricetta" con il counter del DB HannaCode
    ...
    Call GetPreparationSTDGrid(Grid1, uPreparation)
        ...
        lbMRStock = .HannaCode.MR.STOCK_UNIT
        uRecipe = .Recipe
...
Set frmPreparation_Manual = Nothing
End Sub
...
rc = IIf(Len(txFormulation(Index)) > 0, True, False)
   ...
   ' frCommandInside(0).Visible = IIf(Len(txFormulation(4)) And Len(txFormulation(11)) > 0 And Len(txFormulation(4)) > 0, True, False)
   ' frCommandInside(1).Visible = IIf(Len(txFormulation(4)) And Len(txFormulation(11)) > 0 And Len(txFormulation(4)) > 0, True, False)
    frSTD_ID.Visible = IIf(Len(txFormulation(4)) And Len(txFormulation(11)) > 0 And Len(txFormulation(4)) > 0, True, False)
    ...
    Select Case Index
        ...
        Case 14
            uPreparation.HannaCode.Code = txFormulation(14)
            lbHannaCode = uPreparation.HannaCode.Code
        Case 3
            uPreparation.HannaCode.Description = txFormulation(3)

        Case 4, 11 ' std value & std volume
            
            'frCommandInside(1).Visible = IIf(Len(txFormulation(Index)) > 0, True, False)
        Case 18
            frCommandInside(28).Visible = rc
...
End If
        ...
        If Index = 11 Then
            ...
            If CheckPreparation Then
            Else
                If F_MsgBox.DoShow("Preparation already started" & vbCrLf & "change Value and reset preparation?") Then
                Else
                    Exit Sub
                End If
            End If
        ...
        If F_InputBox.DoShow("Enter Value :", sString, , , , Answer, , bNumber, Me.Top) Then
            ...
            Select Case Index
                ...
                Case 4
                 ...
                 Case 11
                    ...
                    If Answer = "" Then
                    Else
                        If CDbl(Answer) > 0 Then
                        
                                uPreparation.ManualValue = Answer
                                txFormulation(11) = uPreparation.ManualValue
                        
                            Else
                                PopupMessage 2, "Please enter a valid Value...", , True
                        End If
                    End If
...
Dim UserSTDNumber As String
    ...
    Select Case Index
        ...
        Case 25
            ...
            PBContainer.Top = -frInside(0).Top + 680
...
Dim sString As String
Dim cells() As String
    If F_MsgBox.DoShow("Do print QRCode for STD?", uPreparation.HannaCode.Code) Then
        
        Call SetHannaCodeDataPreparation
        ...
        With QRCode
            ...
            .Time = (FormatDateTime(Now(), vbShortTime))
            .Text3 = "STD Production"
            .STDv = txFormulation(11) & " " & lbMRUnit
            .Exp = uPreparation.HannaCode.STDExpDate
            .Storage = txFormulation(9)
            
            '-----------------------
            'Improvement Gen 2025
            '-----------------------
            'Bottle  As String
            'SuppLot As String
            'MNP     As String
            ...
            acqCount = Grid2.Rows - 1
            ReDim cells(5)
            For i = 1 To acqCount
               
                 cells(1) = cells(1) & IIf(i > 1, ";", "") & Grid2.Cell(i, 3).Text
                 cells(2) = cells(2) & IIf(i > 1, ";", "") & Grid2.Cell(i, 1).Text
                 cells(3) = cells(3) & IIf(i > 1, ";", "") & Grid2.Cell(i, 2).Text
                 cells(4) = cells(4) & IIf(i > 1, ";", "") & Grid2.Cell(i, 18).Text
                 cells(5) = cells(5) & IIf(i > 1, ";", "") & Grid2.Cell(i, 19).Text
               
                 '";" & Grid2.Cell(i, 2).Text & ";" & Grid2.Cell(i, 3).Text & ";" & Grid2.Cell(i, 18).Text & sQRSeparator & Grid2.Cell(i, 19).Text & sQRSeparator
            
            Next
            .strAcquisitions = cells(1) & sQRSeparator & cells(2) & sQRSeparator & cells(3) & sQRSeparator & cells(4) & sQRSeparator & cells(5)
            
             Call PrintStandardLabel(QRCode, True)
...
rc = True
    ...
    Call FillGridPreparationFromFile(Grid2, uPreparation, 2, PreparationID, , True)
    Call FillGridPreparationFromFile(Grid1, uPreparation, 1, PreparationID, bAcquisitiTutti, True)
...
Private Sub SetBottleTable(ByVal bTutti As Boolean, ByVal bMotherSolution As Boolean)
    ...
    Else
        ...
        If uRecipe.AcquisitionCount > 0 Then
            If uRecipe.Acquisitions(uRecipe.AcquisitionCount - 1).Code = uRecipe.Code Then
                strLott = uRecipe.Acquisitions(uRecipe.AcquisitionCount - 1).MRLot
            End If
        End If
    ...
    Else
        MessageInfoTime = 2000
        PopupMessage 2, "NO ENTRIES! Check MR Stock Bottles for this Code", , , uRecipe.HannaCode.MR.Code
...
Private Function AddAcquisition()
 Dim STDType As Integer
    ...
    If lSTDRow = 0 Then Exit Function
     If MRCode = "" Or bPreparationClosed Then Exit Function
    ...
    With uRecipe.STD(lSTDRow)
        ...
        If .Value > 0 And .Variance = 0 Then
            ...
            If .TheoreticalWeight = .RealWeight Then
                ' ho acquisito tutto....
                PopupMessage 2, "MR Acquired...", , , .MRCode
                Exit Function
            End If
    ...
    If txAcquisition(10) = 0 And uRecipe.STD(lSTDRow).Value = 0 Then
        ...
        If F_MsgBox.DoShow(uRecipe.STD(lSTDRow).MRCode & vbCrLf & "Acquire?", lbInside(2)) Then
...
Dim Note As String
    ...
    If Index = 9 Then
        ...
        ' pipette....
        '-------------
        strPipette = GetSetting(App.Title, "Preparation", "PipetteID", "")
        'strPipette = txAcquisition(9)
        
        If F_InputBox.DoShow("Enter Code :", "STD preparation : Pipette", , , , strPipette) Then
        
            SaveSetting App.Title, "Preparation", "PipetteID", strPipette
    ...
    If Index = 17 Then
        ...
        If F_InputBox.DoShow("Enter Note :", "Acquisition Details", , , , Note) Then
        
            txAcquisition(17) = Note
        ...
        ReDim uBottle(0)
          ...
          With uBottle(0)
             ...
             End If
              ...
              txAcquisition(3) = FormatDataLAT(.ArrivedTime)
              txAcquisition(2) = FormatDataLAT(.SupplierEXP)
              txAcquisition(4) = .Purity
              txAcquisition(5) = .Density
              txAcquisition(6) = FormatDataLAT(.Open)
              txAcquisition(7) = FormatDataLAT(.MREXP)
...
Dim rc As Boolean
    ...
    If uRecipe.STD(lSTDRow).Value <> 0 Then
        ...
        If txAcquisition(9) = "" Then
            ...
            PopupMessage 2, "Please Enter Pipette, Scale and Glassware...", , , "EQUIPMENT"
        ...
        If Trim(uBottle(0).MREXP) = "" Or IsNull(uBottle(0).MREXP) Then
            uBottle(0).MREXP = CreateMRExp(uBottle(0).SupplierEXP, uPreparation.HannaCode.MR.ReductionExpDays)
        End If
        
        Dim MNP As String
        Call GetSupplier(uBottle(0).MRCode, MNP)
        uBottle(0).MNP = MNP
    ...
    If .STDcount > 0 Then
        ...
        For i = 1 To .STDcount
            ...
            If Abs(.STD(i).RealWeight - .STD(i).TheoreticalWeight) > TolerancePerc * .STD(i).TheoreticalWeight Then
                ...
                PopupMessage 2, "Acquire for " & .STD(i).MRCode & vbCrLf & "STD Value = " & .STD(i).Value & vbCrLf & "Bottle Left = " & uBottle(0).StockQTY & uBottle(0).stockUnit
...
Dim AcquisitionsCount As Integer
    ...
    With userAcquisition
       ...
       ' .MotherSolutionDate=
        ...
        .MNP = uBottle(0).MNP
        .ExpMR = FormatDataLAT(uBottle(0).MREXP)
...
With dbTabAcquisition
   ...
   !MotherSolutionDate = IIf(IsNull(userAcquisition.MotherSolutionDate) Or userAcquisition.MotherSolutionDate = "", 0, userAcquisition.MotherSolutionDate)
    ...
    !MNP = IIf(IsNull(userAcquisition.MNP) Or userAcquisition.MNP = "", 0, userAcquisition.MNP)
    !ExpMR = IIf(IsNull(userAcquisition.ExpMR), "", userAcquisition.ExpMR)
    
    !CodicePipetta = userAcquisition.CodicePipetta
    !PipettaType = userAcquisition.PipettaType
    
    !ScaleID = userAcquisition.ScaleID
    !GlasswareID = userAcquisition.GlasswareID
    !bManuale = True 'userAcquisition.bManuale
...
Private Function AddMR() As Boolean
Dim strMRTheor As String
Dim i As Integer
Dim t As Integer
Dim Count As Long
...
With Grid1
    ...
    Count = .Rows - 1
        ...
        If F_MsgBox.DoShow("Enter new MR?") Then
        
            DoEvents
            If FormChemicalMR.DoShow(SelectedCode) Then
            ...
            End If
               ...
               For t = 1 To .Rows - 1
                    ...
                    If .Cell(t, 1).Text = SelectedCode Then
                ...
                uRecipe.STD(.Rows - 1).MRCode = SelectedCode
                
                .Cell(.Rows - 1, 1).Text = SelectedCode
                
                .Cell(.Rows - 1, 2).Text = txFormulation(11)
                .Cell(.Rows - 1, 3).Text = lbMRUnit
                
                uRecipe.STD(.Rows - 1).Value = txFormulation(11)
                uRecipe.STD(.Rows - 1).Unit = lbMRUnit
                
                
               
               If F_InputBox.DoShow("Enter Numeric Value (g) :", "MR Qty  (Theoretical Weight)", , , , strMRTheor, , True) Then
                    uRecipe.STD(.Rows - 1).TheoreticalWeight = CDbl(strMRTheor)
                    .Cell(.Rows - 1, 4).Text = strMRTheor
                End If
...
If MRCode <> "" And MRCode <> "9999" Then

     
    If F_MsgBox.DoShow("Delete MR : " & MRCode & vbCrLf & "Acquired : " & Trim(PadString(UserSTDValue)), "Delete MR", True) Then
   ...
   If txFormulation(12) <> "" Then uPreparation.MS.Volume = txFormulation(12)
    ...
    If .Rows > 0 Then
        ...
        For i = 1 To .Rows - 1
            ...
            uRecipe.STD(i).MRCode = .Cell(i, 1).Text
...
'SetSTD_ID = FormatID(Trim(txFormulation(11)) & FormatDateTime(Now(), vbShortDate))
 SetSTD_ID = IIf(Trim(txFormulation(18)) = "", FormatID(FormatDateTime(Now())), txFormulation(18))
    txFormulation(18) = SetSTD_ID
            
uPreparation.HannaCode.STD = uRecipe.STD
uPreparation.Recipe = uRecipe
uPreparation.STD_Manual_ID = SetSTD_ID
...
Dim MRConc As Double

With uPreparation

    If txFormulation(12) = "" Then Exit Function
    If .MS.Qty = 0 Then Exit Function
   
    txFormulation(11) = FormatNumber(uRecipe.TotalWeight, 3)
    txFormulation(13) = FormatNumber(.MS.Qty, 3)
    
    'MRConc = (txFormulation(12) / .MS.Qty) / 100
    If .MsType = 1 Then
    
        MRConc = (.HannaCode.MR.MRValue / .HannaCode.MS2vol)
    
    ElseIf .MsType = 2 Then
        If .HannaCode.MS2vol <> 0 Then
            MRConc = (.HannaCode.MR.MRValue / .HannaCode.MS2vol)
        Else
            MRConc = (.HannaCode.MR.MRValue / .HannaCode.MS2vol)
        End If
    ...
    'MRConc = (.MS.Qty / .MS.DilConc)
    
    txFormulation(17) = FormatNumber(MRConc, 2) & " %"
    lbMRStock = .HannaCode.MR.STOCK_UNIT
...
If AcquisitionID > 0 And AcquisitionMR <> "" Then

     
    If F_MsgBox.DoShow("Delete MR Acquisition : " & AcquisitionMR & vbCrLf & "Weight : " & Trim(PadString(AcquisitionWeight)) & "g", SelectedHannaCode, True) Then
    ...
    With uRecipe
      ...
      '  Debug.Print .Acquisitions(lAcquisitionRow).ActualWeight
        ...
        For i = 1 To .STDcount
            ...
            If .STD(i).MRCode = AcquisitionMR Then
    ...
    If F_MsgBox.DoShow("Standard not found in Recipe. Delete acquisition anyway?", AcquisitionMR) Then
    Else
        Exit Function
    End If
...
Private Function SavePreparation() As Boolean
Dim rc As Boolean
Dim i As Integer
...
On Error GoTo ERR_SAVE:
    ...
    PopupMessage 2, "Preparation correctly Saved", , , lbHannaCode
ERR_END:
    On Error GoTo 0
    SavePreparation = rc
    Exit Function
ERR_SAVE:
    rc = False
    PopupMessage 2, "Preparation Error!"
    Resume ERR_END:
End Function
...
Private Sub SetClosedPreparation(ByVal rc As Boolean)
    ...
    frCommandInside(5).Visible = False
    frCommandInside(10).Visible = False ' Not (rc)
...
Private Sub frExcel_Click()
    ...
    Else
        ...
        ExcelFilename = "PREP_" & FormatNomeFile(Trim(uPreparation.HannaCode.Code) & ".MANUAL." & Trim(uPreparation.DataPrep) & "." & Trim(uPreparation.HourPrep))
       ...
       ''' SettingName = FormatNomeFile(Trim(uRecipe.HannaCode.Code) & "." & Trim(uRecipe.Code) & "." & txFormulation(1) & "." & txFormulation(2) & "." & txFormulation(3)) & "." & USER_ESTENSIONE_PREPARATION
        ...
        Call EsportaPreparationExcel(SettingName, ExcelFilename, uPreparation, True)
    End If
...
Dim Um As String
    ...
    uRecipe.STD(lSTDRow).Value = txFormulation(11)
...
Dim rc As Boolean
    ...
    txFormulation(17).BackColor = IIf(IconMS.Visible, vbColorGreen, vbWhite)
    txFormulation(17).ForeColor = IIf(IconMS.Visible, vbWhite, &H644603)
...
With uPreparation
   ...
   If .MS.Qty <= uBottle.StockQTY Then
        ...
        '
        If F_MsgBox.DoShow("Prepare Mother Solution = " & txFormulation(12) & " " & Label8 & vbCrLf & "MR Qty = " & txFormulation(13) & lbMRStock & vbCrLf & "With Bottle =" & uBottle.EntryBottle & " ?", "Mother solution") Then
        Else
            Exit Function
        End If
        ...
        If Trim(uBottle.MREXP) = "" Or IsNull(uBottle.MREXP) Then
            uBottle.MREXP = CreateMRExp(uBottle.SupplierEXP, uPreparation.HannaCode.MR.ReductionExpDays)
        End If
...
rc = True
    ...
    If uRecipe.STD(lSTDRow).Value = 0 Then
            ...
            ' ma cosa???
            frCommandInside(8).Visible = True
            If F_MsgBox.DoShow(uRecipe.STD(lSTDRow).MRCode & vbCrLf & "STD Value : " & uRecipe.STD(lSTDRow).Value & vbCrLf & "Acquire?", lbInside(2)) Then
...
End With
    ...
    strData = uRecipe.STD(lSTDRow).MRCode '& " | VALUE = " & uRecipe.STD(lSTDRow).Value
...
With uPreparation.MotherSol
    ...
    If uRecipe.STD(lSTDRow).Value <> 0 Then
       ...
       Dim strPipette As String
        ...
        If F_InputBox.DoShow("Enter Type :", "STD preparation : Pipette Type", , , , strPipette) Then
        
           userAcquisition.PipettaType = strPipette
...
Dim strNote As String
    ...
    With userAcquisition
       ...
       ' .MotherSolutionDate=
        ...
        .MotherSolutionDate = uPreparation.MotherSol.DataMS
        .MNP = uPreparation.MotherSol.Bottle.MNP
        .ExpMR = FormatDataLAT(uPreparation.MotherSol.Bottle.MREXP)
    ...
    End With
     ...
     frInside(6).Top = frInside(4).Top
      frInside(6).Left = frInside(4).Left
            ...
            PBContainer.Top = -frInside(6).Top + 680
                  
End Function



Private Function EquipmentSelection()
'----------------------
' Equipment Selection
'----------------------
Dim ScaleID As String
Dim GlasswareID As String
     
ScaleID = GetSetting(App.Title, "Preparation", "ScaleID", "")
 If F_InputBox.DoShow("Enter Value :", "Scale Code/ID", , , , ScaleID) Then

   userAcquisition.ScaleID = ScaleID
   SaveSetting App.Title, "Preparation", "ScaleID", ScaleID

End If

GlasswareID = GetSetting(App.Title, "Preparation", "GlasswareID", "")
If F_InputBox.DoShow("Enter Value :", "Glassware Code/ID", , , , GlasswareID) Then

   userAcquisition.GlasswareID = GlasswareID
   SaveSetting App.Title, "Preparation", "GlasswareID", GlasswareID
