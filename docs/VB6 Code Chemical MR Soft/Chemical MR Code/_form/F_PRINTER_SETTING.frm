...
Begin VB.Form F_PRINTER_SETTING 
   ...
   Begin VB.Image Image3 
      ...
      Index           =   0
      Left            =   360
      Picture         =   "F_PRINTER_SETTING.frx":ACEF4
      Top             =   480
      Width           =   480
   End
   Begin VB.Label lb 
   ...
   Begin VB.Label Label1 
      ...
      Index           =   0
      Left            =   2880
      MouseIcon       =   "F_PRINTER_SETTING.frx":B02D6
   ...
   Begin VB.Label Label1 
      ...
      Index           =   1
      Left            =   8880
      MouseIcon       =   "F_PRINTER_SETTING.frx":B05E0
      MousePointer    =   99  'Custom
      TabIndex        =   0
      Top             =   3480
      Width           =   5655
...
Private Sub ScriviPredefinita()
  lb(0) = "Default priner : " + vbCrLf + Printer.DeviceName
End Sub
...
Private Sub SetPrinter()
  ...
  For Each prn In Printers
    ...
    End If
  Next
  lb(0) = "Selected printer : " + vbCrLf + Printer.DeviceName
