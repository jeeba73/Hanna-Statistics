...
Begin VB.Form frmPreparation_Static 
   Appearance      =   0  'Flat
   BackColor       =   &H80000005&
   Caption         =   "Chemical MR"
   ClientHeight    =   11880
   ...
   End
End
Attribute VB_Name = "frmPreparation_Static"
...
UserSTDValue = 9999
    ...
    If FirstRow > 0 Then
            ...
            lSTDCol = FirstCol
            'Debug.Print Trim(Grid1.Cell(FirstRow, 5).Text)
       ...
       Call STDRefreshTotalMSVolume
        ...
        Select Case .MsType
            ...
            Case 0
                frMS.Visible = False
            Case 1
                frMS.Visible = True ' IIf(Len(txFormulation(11)) > 0, True, False)
...
Set frmPreparation_Static = Nothing
End Sub
...
rc = IIf(Len(txFormulation(Index)) > 0, True, False)
    ...
    Select Case Index
        ...
        Case 11
            If uPreparation.MsType > 0 Then frMS.Visible = rc
            
        Case 12
            uPreparation.HannaCode.MS1vol = txFormulation(12)
            uPreparation.HannaCode.MS2vol = txFormulation(12)
             txFormulation(12).BackColor = IIf(txFormulation(12) <= "0", vbRed, vbColorGreen)
             If rc = False Then txFormulation(12).BackColor = vbWhite
    End Select
...
Dim UserSTDNumber As String
    ...
    Select Case Index
        ...
        Case 28
            ' print QRCode
            If F_MsgBox.DoShow("Do print QRCode for STD?", "STD" & STDNumber) Then
                
                Call PrintStandardLabel(QRCode, False)
...
Dim AcquisitionsCount As Integer
    ...
    With userAcquisition
       ...
       ' .MotherSolutionDate=
        ...
        .MotherSolutionDate = uPreparation.MotherSol.Bottle.MREXP
...
If STDNumber <> "" And STDNumber <> "9999" Then

     
    If F_MsgBox.DoShow("Delete Standard : " & STDNumber & vbCrLf & "Value : " & Trim(PadString(UserSTDValue)), "Delete STD", True) Then
...
With Grid1
   ...
   If txFormulation(12) <> "" Then uPreparation.MS.Volume = txFormulation(12)
    ...
    If .Rows > 1 Then
        ...
        ReDim uPreparation.HannaCode.STD(.Rows - 1)
        ...
        For i = 1 To .Rows - 1
           ...
           ' SetSTD_ID = FormatID(uPreparation.HannaCode.Code & "-STD_" & uRecipe.STD(i).NUMBER & "-" & Now())
           ' SetSTD_ID = FormatID(Trim(txFormulation(11)) & FormatDateTime(Now(), vbShortDate))
            SetSTD_ID = IIf(Trim(.Cell(i, 10).Text) <> "", .Cell(i, 10).Text, FormatID(FormatDateTime(Now())))
            
            If i <= UBound(uPreparation.HannaCode.STD) Then
            
                If uRecipe.STD(i).RealWeight >= 0 Then
                    If uPreparation.HannaCode.STD(i).STD_ID = "" Then
                    uPreparation.HannaCode.STD(i).STD_ID = SetSTD_ID
                    End If
                    
                End If
                
                 uRecipe.STD(i).STD_ID = uPreparation.HannaCode.STD(i).STD_ID
...
With uPreparation
    ...
    ElseIf .MsType = 2 Then
        ...
        If .HannaCode.MS2vol <> "0" And .HannaCode.MS2vol <> "" Then
...
Dim rc As Boolean
    ...
    frCommandInside(30).Visible = IconMS.Visible
...
With uPreparation
   ...
   If .MS.Qty <= uBottle.StockQTY Then
        ...
        End If
        Dim MNP As String
        Call GetSupplier(uBottle.MRCode, MNP)
        uBottle.MNP = MNP
